#  LP written by GAMS Convert at 12/13/18 11:43:36
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#          6        1        3        2        0        0        0        0
...
m.c4 = Constraint(expr=   m.x1 + m.x4 >= 352.0227399)

m.c5 = Constraint(expr=   m.x2 + m.x5 >= 331.55145636)

m.c6 = Constraint(expr=   m.x3 + m.x6 >= 277.951216235)
