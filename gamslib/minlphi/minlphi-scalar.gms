...
e1.. -(0.4*((-1.15398 + 0.003375*x30)*x2 + (-0.30630793 + 0.000893*x31)*x3 + (-
     ...
     4.75228*x23 + 4.75228*x24 + 4.75228*x25 + 2.418*x26 + 2.418*x27 + 2.418*
     x28 + 2.418*x29) + x1 =E= 67.56864;
...
e7..    x43 + x51 + x55 =L= 1500;

e8..    x44 + x52 + x56 =L= 0;

e9..    x45 + x53 + x57 =L= 1500;

e10..    x46 + x58 + x62 =L= 0;

e11..    x47 + x59 + x63 =L= 1500;

e12..    x48 + x60 + x64 =L= 0;

e13..    x49 + x61 + x65 =L= 1500;

e14..    x30 + x34 + x38 =L= 1500;

e15..    x31 + x35 + x39 =L= 0;

e16..    x32 + x36 + x40 =L= 1500;
