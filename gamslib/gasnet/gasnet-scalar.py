...
m.x38 = Var(within=Reals,bounds=(4,18),initialize=18)
m.x39 = Var(within=Reals,bounds=(4,18),initialize=18)
m.x40 = Var(within=Reals,bounds=(4,18),initialize=18)
m.x41 = Var(within=Reals,bounds=(4,18),initialize=18)
m.x42 = Var(within=Reals,bounds=(4,18),initialize=18)
m.x43 = Var(within=Reals,bounds=(4,18),initialize=18)
m.x44 = Var(within=Reals,bounds=(4,18),initialize=18)
m.x45 = Var(within=Reals,bounds=(4,18),initialize=18)
...
m.c35 = Constraint(expr=-214.9812*(-1 + m.x58**0.181587301587302)*m.x47 + m.x68 == 0)

m.c36 = Constraint(expr=-214.9812*(-1 + m.x59**0.181587301587302)*m.x48 + m.x69 == 0)

m.c37 = Constraint(expr=-214.9812*(-1 + m.x60**0.181587301587302)*m.x49 + m.x70 == 0)

m.c38 = Constraint(expr=-214.9812*(-1 + m.x61**0.181587301587302)*m.x50 + m.x71 == 0)

m.c39 = Constraint(expr=-214.9812*(-1 + m.x61**0.181587301587302)*m.x54 + m.x71 == 0)

m.c40 = Constraint(expr=-214.9812*(-1 + m.x62**0.181587301587302)*m.x51 + m.x72 == 0)

m.c41 = Constraint(expr=-214.9812*(-1 + m.x63**0.181587301587302)*m.x52 + m.x73 == 0)

m.c42 = Constraint(expr=-214.9812*(-1 + m.x64**0.181587301587302)*m.x53 + m.x74 == 0)

m.c43 = Constraint(expr=-214.9812*(-1 + m.x65**0.181587301587302)*m.x55 + m.x75 == 0)

m.c44 = Constraint(expr=-214.9812*(-1 + m.x66**0.181587301587302)*m.x56 + m.x76 == 0)

m.c45 = Constraint(expr=-214.9812*(-1 + m.x67**0.181587301587302)*m.x57 + m.x77 == 0)
