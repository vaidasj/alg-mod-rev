#  NLP written by GAMS Convert at 12/13/18 10:32:23
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#         13       10        1        2        0        0        0        0
...
m.c3 = Constraint(expr=10*m.x7*m.x9 - 0.00968946189201593*(m.x1**4 - m.x2**4)*m.x3 == 0)
...
m.c7 = Constraint(expr=log10(0.8 + 8.112*m.x3) - 10964781961.4319*m.x11**(-3.55) == 0)
