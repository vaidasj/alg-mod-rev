#  NLP written by GAMS Convert at 10/11/20 12:22:29
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#        243      243        0        0        0        0        0        0
...
JuMP.set_NL_objective(m, MOI.MAX_SENSE, :($(x213)^0.2744*$(x214)^0.00445*$(x216)^0.05599*$(x217)^0.14099*$(x218)^0.17738
    *$(x221)^0.004*$(x222)^0.31921*$(x223)^0.02358))
