...
minimize obj: 150*((1e-6 + 2*x25/(1e-6 + (1e-6 + 0.5*x41*x42*(x41 + x42))**
    ...
    *(x50 + x51))**0.33333))**1 + (1e-6 + 2*x35/(1e-6 + (1e-6 + 0.5*x51*x52*(
    ...
    x56*(90 + 0.5*x56))**0.33333)**1 + 150*((1e-6 + 2*x37/(1e-6 + 35*x53*(70 + 
    x53))**0.33333)**1 + (1e-6 + 2*x38/(1e-6 + 35*x54*(70 + x54))**0.33333)**1)
     + 80*x39 + 80*x40 + 15*x37 + 15*x38 + 5500*b1 + 5500*b2 + 5500*b3
