...
m.obj = Objective(expr=150*((1e-6 + 2*m.x25/(1e-6 + (1e-6 + 0.5*m.x41*m.x42*(m.x41 + m.x42))**0.33333))**1 + (1e-6 + 2*
                       ...
                       m.x55))**0.33333 + 1.2*m.x40/(1e-6 + 180*m.x56*(90 + 0.5*m.x56))**0.33333)**1 + 150*((1e-6 + 2*
                       m.x37/(1e-6 + 35*m.x53*(70 + m.x53))**0.33333)**1 + (1e-6 + 2*m.x38/(1e-6 + 35*m.x54*(70 + m.x54)
                       )**0.33333)**1) + 80*m.x39 + 80*m.x40 + 15*m.x37 + 15*m.x38 + 5500*m.b1 + 5500*m.b2 + 5500*m.b3
