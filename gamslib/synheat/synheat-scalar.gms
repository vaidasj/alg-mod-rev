...
*        225      193       32        0
*
*  Solve m using MINLP minimizing x57;
...
e65.. -(150*((1e-6 + 2*x25/(1e-6 + (1e-6 + 0.5*x41*x42*(x41 + x42))**0.33333))
      **1 + (1e-6 + 2*x26/(1e-6 + (1e-6 + 0.5*x42*x43*(x42 + x43))**0.33333))**
      ...
      (2e-6 + 1.2*x39/(1e-6 + 30*x55*(15 + 0.5*x55))**0.33333 + 1.2*x40/(1e-6
       + 180*x56*(90 + 0.5*x56))**0.33333)**1 + 150*((1e-6 + 2*x37/(1e-6 + 35*
      x53*(70 + x53))**0.33333)**1 + (1e-6 + 2*x38/(1e-6 + 35*x54*(70 + x54))**
      0.33333)**1) + 80*x39 + 80*x40 + 15*x37 + 15*x38) - 5500*b1 - 5500*b2
       - 5500*b3 - 5500*b4 - 5500*b5 - 5500*b6 - 5500*b7 - 5500*b8 - 5500*b9
       - 5500*b10 - 5500*b11 - 5500*b12 + x57 =E= 0;
