#  MCP written by GAMS Convert at 10/11/20 12:28:18
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#         78       78        0        0        0        0        0        0
...
@variable(m, x25, start=711.6443)
@variable(m, x26, start=930.3509)
@variable(m, x27, start=497.4428)
@variable(m, x28, start=657.3677)
@variable(m, x29, start=840.05)
@variable(m, x30, start=515.4296)
@variable(m, x31, start=641.7037)
@variable(m, x32, start=812.2222)
@variable(m, x33, start=492.0307)
@variable(m, x34, start=15.6639)
@variable(m, x35, start=27.8278)
@variable(m, x36, start=23.3988)
@variable(m, x37, start=69.9406)
@variable(m, x38, start=118.1287)
@variable(m, x39, start=5.412)
...
@variable(m, x43, start=0.074)
@variable(m, x44, start=0.14)
@variable(m, x45, start=0.152)
...
@variable(m, x49, start=2515.9)
@variable(m, x50, start=442.643)
@variable(m, 0 <= x51 <= 0, start=0)
@variable(m, 0 <= x52 <= 0, start=0)
@variable(m, x53, start=767.776)
@variable(m, 0 <= x54 <= 0, start=0)
@variable(m, 0 <= x55 <= 0, start=0)
@variable(m, x56, start=355.568)
@variable(m, x57, start=948.1)
@variable(m, x58, start=256.645)
@variable(m, x59, start=464.1656)
@variable(m, x60, start=156.2598)
...
@variable(m, x73, start=1123.5941)
...
JuMP.add_NL_constraint(m, :(-$(x61)^0.47*$(x62)^0.31999*$(x63)^0.21001 + $(x96) == 0))
