...
m.c3 = Constraint(expr=-0.571428571428571*m.x29*m.x1/m.x27 + m.x3 == 0)

m.c4 = Constraint(expr=-0.545454545454545*m.x30*m.x2/m.x27 + m.x4 == 0)

m.c5 = Constraint(expr=-0.428571428571429*m.x29*m.x1/m.x28 + m.x5 == 0)

m.c6 = Constraint(expr=-0.454545454545455*m.x30*m.x2/m.x28 + m.x6 == 0)

m.c7 = Constraint(expr=   m.x7 - 0.287671232876712*m.x11 == 0)

m.c8 = Constraint(expr=   m.x8 - 0.111111111111111*m.x12 == 0)

m.c9 = Constraint(expr=   m.x9 - 0.232876712328767*m.x11 == 0)

m.c10 = Constraint(expr=   m.x10 - 0.125*m.x12 == 0)

m.c11 = Constraint(expr=   m.x1 - 0.479452054794521*m.x11 == 0)

m.c12 = Constraint(expr=   m.x2 - 0.763888888888889*m.x12 == 0)
...
m.c15 = Constraint(expr= - 12.7777777777778*m.x27 - 10.2222222222222*m.x28 + m.x44 == 0)
...
m.c24 = Constraint(expr= - 9.44444444444444*m.x27 - 7.55555555555556*m.x28 + m.x42 == 0)
...
m.c26 = Constraint(expr=-(20*m.x27 + 16*m.x28 - 0.4*m.x42 - 0.4*m.x44)/m.x33 + m.x13 == 0)

m.c27 = Constraint(expr=-(30*m.x27 + 24*m.x28 - 0.6*m.x42 - 0.6*m.x44)/m.x34 + m.x14 == 0)
...
m.c47 = Constraint(expr=   m.x3 + m.x4 == 50)
