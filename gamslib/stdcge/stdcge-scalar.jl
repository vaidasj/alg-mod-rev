#  NLP written by GAMS Convert at 10/11/20 12:52:01
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#         49       49        0        0        0        0        0        0
...
@constraint(m,  - 12.7777777777778*x27 - 10.2222222222222*x28 + x44 == 0)
...
@constraint(m,  - 9.44444444444444*x27 - 7.55555555555556*x28 + x42 == 0)
...
JuMP.add_NL_constraint(m, :(-(20*$(x27) + 16*$(x28) - 0.4*$(x42) - 0.4*$(x44))/$(x33) + $(x13) == 0))

JuMP.add_NL_constraint(m, :(-(30*$(x27) + 24*$(x28) - 0.6*$(x42) - 0.6*$(x44))/$(x34) + $(x14) == 0))
