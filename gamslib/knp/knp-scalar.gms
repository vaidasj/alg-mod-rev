*  NLP written by GAMS Convert at 12/13/18 11:24:26
*  
*  Equation counts
*      Total        E        G        L        N        X        C        B
...
*       2580      276     2304        0
*
*  Solve m using NLP maximizing x97;
...
e25.. sqr(x1 - x5) + sqr(x2 - x6) + sqr(x3 - x7) + sqr(x4 - x8) - 4*x97 =G= 0;

e26.. sqr(x1 - x9) + sqr(x2 - x10) + sqr(x3 - x11) + sqr(x4 - x12) - 4*x97
       =G= 0;

e27.. sqr(x1 - x13) + sqr(x2 - x14) + sqr(x3 - x15) + sqr(x4 - x16) - 4*x97
       =G= 0;

e28.. sqr(x1 - x17) + sqr(x2 - x18) + sqr(x3 - x19) + sqr(x4 - x20) - 4*x97
       =G= 0;

e29.. sqr(x1 - x21) + sqr(x2 - x22) + sqr(x3 - x23) + sqr(x4 - x24) - 4*x97
       =G= 0;

e30.. sqr(x1 - x25) + sqr(x2 - x26) + sqr(x3 - x27) + sqr(x4 - x28) - 4*x97
       =G= 0;

e31.. sqr(x1 - x29) + sqr(x2 - x30) + sqr(x3 - x31) + sqr(x4 - x32) - 4*x97
       =G= 0;

e32.. sqr(x1 - x33) + sqr(x2 - x34) + sqr(x3 - x35) + sqr(x4 - x36) - 4*x97
       =G= 0;

e33.. sqr(x1 - x37) + sqr(x2 - x38) + sqr(x3 - x39) + sqr(x4 - x40) - 4*x97
       =G= 0;

e34.. sqr(x1 - x41) + sqr(x2 - x42) + sqr(x3 - x43) + sqr(x4 - x44) - 4*x97
       =G= 0;

e35.. sqr(x1 - x45) + sqr(x2 - x46) + sqr(x3 - x47) + sqr(x4 - x48) - 4*x97
       =G= 0;

e36.. sqr(x1 - x49) + sqr(x2 - x50) + sqr(x3 - x51) + sqr(x4 - x52) - 4*x97
       =G= 0;

e37.. sqr(x1 - x53) + sqr(x2 - x54) + sqr(x3 - x55) + sqr(x4 - x56) - 4*x97
       =G= 0;

e38.. sqr(x1 - x57) + sqr(x2 - x58) + sqr(x3 - x59) + sqr(x4 - x60) - 4*x97
       =G= 0;

e39.. sqr(x1 - x61) + sqr(x2 - x62) + sqr(x3 - x63) + sqr(x4 - x64) - 4*x97
       =G= 0;

e40.. sqr(x1 - x65) + sqr(x2 - x66) + sqr(x3 - x67) + sqr(x4 - x68) - 4*x97
       =G= 0;

e41.. sqr(x1 - x69) + sqr(x2 - x70) + sqr(x3 - x71) + sqr(x4 - x72) - 4*x97
       =G= 0;

e42.. sqr(x1 - x73) + sqr(x2 - x74) + sqr(x3 - x75) + sqr(x4 - x76) - 4*x97
       =G= 0;

e43.. sqr(x1 - x77) + sqr(x2 - x78) + sqr(x3 - x79) + sqr(x4 - x80) - 4*x97
       =G= 0;

e44.. sqr(x1 - x81) + sqr(x2 - x82) + sqr(x3 - x83) + sqr(x4 - x84) - 4*x97
       =G= 0;

e45.. sqr(x1 - x85) + sqr(x2 - x86) + sqr(x3 - x87) + sqr(x4 - x88) - 4*x97
       =G= 0;

e46.. sqr(x1 - x89) + sqr(x2 - x90) + sqr(x3 - x91) + sqr(x4 - x92) - 4*x97
       =G= 0;

e47.. sqr(x1 - x93) + sqr(x2 - x94) + sqr(x3 - x95) + sqr(x4 - x96) - 4*x97
       =G= 0;

e48.. sqr(x5 - x9) + sqr(x6 - x10) + sqr(x7 - x11) + sqr(x8 - x12) - 4*x97
       =G= 0;

e49.. sqr(x5 - x13) + sqr(x6 - x14) + sqr(x7 - x15) + sqr(x8 - x16) - 4*x97
       =G= 0;

e50.. sqr(x5 - x17) + sqr(x6 - x18) + sqr(x7 - x19) + sqr(x8 - x20) - 4*x97
       =G= 0;

e51.. sqr(x5 - x21) + sqr(x6 - x22) + sqr(x7 - x23) + sqr(x8 - x24) - 4*x97
       =G= 0;

e52.. sqr(x5 - x25) + sqr(x6 - x26) + sqr(x7 - x27) + sqr(x8 - x28) - 4*x97
       =G= 0;

e53.. sqr(x5 - x29) + sqr(x6 - x30) + sqr(x7 - x31) + sqr(x8 - x32) - 4*x97
       =G= 0;

e54.. sqr(x5 - x33) + sqr(x6 - x34) + sqr(x7 - x35) + sqr(x8 - x36) - 4*x97
       =G= 0;

e55.. sqr(x5 - x37) + sqr(x6 - x38) + sqr(x7 - x39) + sqr(x8 - x40) - 4*x97
       =G= 0;

e56.. sqr(x5 - x41) + sqr(x6 - x42) + sqr(x7 - x43) + sqr(x8 - x44) - 4*x97
       =G= 0;

e57.. sqr(x5 - x45) + sqr(x6 - x46) + sqr(x7 - x47) + sqr(x8 - x48) - 4*x97
       =G= 0;

e58.. sqr(x5 - x49) + sqr(x6 - x50) + sqr(x7 - x51) + sqr(x8 - x52) - 4*x97
       =G= 0;

e59.. sqr(x5 - x53) + sqr(x6 - x54) + sqr(x7 - x55) + sqr(x8 - x56) - 4*x97
       =G= 0;

e60.. sqr(x5 - x57) + sqr(x6 - x58) + sqr(x7 - x59) + sqr(x8 - x60) - 4*x97
       =G= 0;

e61.. sqr(x5 - x61) + sqr(x6 - x62) + sqr(x7 - x63) + sqr(x8 - x64) - 4*x97
       =G= 0;

e62.. sqr(x5 - x65) + sqr(x6 - x66) + sqr(x7 - x67) + sqr(x8 - x68) - 4*x97
       =G= 0;

e63.. sqr(x5 - x69) + sqr(x6 - x70) + sqr(x7 - x71) + sqr(x8 - x72) - 4*x97
       =G= 0;

e64.. sqr(x5 - x73) + sqr(x6 - x74) + sqr(x7 - x75) + sqr(x8 - x76) - 4*x97
       =G= 0;

e65.. sqr(x5 - x77) + sqr(x6 - x78) + sqr(x7 - x79) + sqr(x8 - x80) - 4*x97
       =G= 0;

e66.. sqr(x5 - x81) + sqr(x6 - x82) + sqr(x7 - x83) + sqr(x8 - x84) - 4*x97
       =G= 0;

e67.. sqr(x5 - x85) + sqr(x6 - x86) + sqr(x7 - x87) + sqr(x8 - x88) - 4*x97
       =G= 0;

e68.. sqr(x5 - x89) + sqr(x6 - x90) + sqr(x7 - x91) + sqr(x8 - x92) - 4*x97
       =G= 0;

e69.. sqr(x5 - x93) + sqr(x6 - x94) + sqr(x7 - x95) + sqr(x8 - x96) - 4*x97
       =G= 0;

e70.. sqr(x9 - x13) + sqr(x10 - x14) + sqr(x11 - x15) + sqr(x12 - x16) - 4*x97
       =G= 0;

e71.. sqr(x9 - x17) + sqr(x10 - x18) + sqr(x11 - x19) + sqr(x12 - x20) - 4*x97
       =G= 0;

e72.. sqr(x9 - x21) + sqr(x10 - x22) + sqr(x11 - x23) + sqr(x12 - x24) - 4*x97
       =G= 0;

e73.. sqr(x9 - x25) + sqr(x10 - x26) + sqr(x11 - x27) + sqr(x12 - x28) - 4*x97
       =G= 0;

e74.. sqr(x9 - x29) + sqr(x10 - x30) + sqr(x11 - x31) + sqr(x12 - x32) - 4*x97
       =G= 0;

e75.. sqr(x9 - x33) + sqr(x10 - x34) + sqr(x11 - x35) + sqr(x12 - x36) - 4*x97
       =G= 0;

e76.. sqr(x9 - x37) + sqr(x10 - x38) + sqr(x11 - x39) + sqr(x12 - x40) - 4*x97
       =G= 0;

e77.. sqr(x9 - x41) + sqr(x10 - x42) + sqr(x11 - x43) + sqr(x12 - x44) - 4*x97
       =G= 0;

e78.. sqr(x9 - x45) + sqr(x10 - x46) + sqr(x11 - x47) + sqr(x12 - x48) - 4*x97
       =G= 0;

e79.. sqr(x9 - x49) + sqr(x10 - x50) + sqr(x11 - x51) + sqr(x12 - x52) - 4*x97
       =G= 0;

e80.. sqr(x9 - x53) + sqr(x10 - x54) + sqr(x11 - x55) + sqr(x12 - x56) - 4*x97
       =G= 0;

e81.. sqr(x9 - x57) + sqr(x10 - x58) + sqr(x11 - x59) + sqr(x12 - x60) - 4*x97
       =G= 0;

e82.. sqr(x9 - x61) + sqr(x10 - x62) + sqr(x11 - x63) + sqr(x12 - x64) - 4*x97
       =G= 0;

e83.. sqr(x9 - x65) + sqr(x10 - x66) + sqr(x11 - x67) + sqr(x12 - x68) - 4*x97
       =G= 0;

e84.. sqr(x9 - x69) + sqr(x10 - x70) + sqr(x11 - x71) + sqr(x12 - x72) - 4*x97
       =G= 0;

e85.. sqr(x9 - x73) + sqr(x10 - x74) + sqr(x11 - x75) + sqr(x12 - x76) - 4*x97
       =G= 0;

e86.. sqr(x9 - x77) + sqr(x10 - x78) + sqr(x11 - x79) + sqr(x12 - x80) - 4*x97
       =G= 0;

e87.. sqr(x9 - x81) + sqr(x10 - x82) + sqr(x11 - x83) + sqr(x12 - x84) - 4*x97
       =G= 0;

e88.. sqr(x9 - x85) + sqr(x10 - x86) + sqr(x11 - x87) + sqr(x12 - x88) - 4*x97
       =G= 0;

e89.. sqr(x9 - x89) + sqr(x10 - x90) + sqr(x11 - x91) + sqr(x12 - x92) - 4*x97
       =G= 0;

e90.. sqr(x9 - x93) + sqr(x10 - x94) + sqr(x11 - x95) + sqr(x12 - x96) - 4*x97
       =G= 0;

e91.. sqr(x13 - x17) + sqr(x14 - x18) + sqr(x15 - x19) + sqr(x16 - x20) - 4*x97
       =G= 0;

e92.. sqr(x13 - x21) + sqr(x14 - x22) + sqr(x15 - x23) + sqr(x16 - x24) - 4*x97
       =G= 0;

e93.. sqr(x13 - x25) + sqr(x14 - x26) + sqr(x15 - x27) + sqr(x16 - x28) - 4*x97
       =G= 0;

e94.. sqr(x13 - x29) + sqr(x14 - x30) + sqr(x15 - x31) + sqr(x16 - x32) - 4*x97
       =G= 0;

e95.. sqr(x13 - x33) + sqr(x14 - x34) + sqr(x15 - x35) + sqr(x16 - x36) - 4*x97
       =G= 0;

e96.. sqr(x13 - x37) + sqr(x14 - x38) + sqr(x15 - x39) + sqr(x16 - x40) - 4*x97
       =G= 0;

e97.. sqr(x13 - x41) + sqr(x14 - x42) + sqr(x15 - x43) + sqr(x16 - x44) - 4*x97
       =G= 0;

e98.. sqr(x13 - x45) + sqr(x14 - x46) + sqr(x15 - x47) + sqr(x16 - x48) - 4*x97
       =G= 0;

e99.. sqr(x13 - x49) + sqr(x14 - x50) + sqr(x15 - x51) + sqr(x16 - x52) - 4*x97
       =G= 0;
