...
*         77       55       22        0
*
*  Solve m using NLP maximizing x34;
...
e1.. 0.759835685651592*x1**0.25 - x12 - x23 =E= 0;
...
e7.. 0.867934991180341*x7**0.25 - x18 - x29 =E= 0;

e8.. 0.88739119671479*x8**0.25 - x19 - x30 =E= 0;

e9.. 0.907283545436971*x9**0.25 - x20 - x31 =E= 0;
...
e23.. -(0.95*log(x12) + 0.9025*log(x13) + 0.857375*log(x14) + 0.81450625*log(
      ...
      *log(x18) + 0.663420431289062*log(x19) + 0.630249409724609*log(x20) + 
      0.598736939238379*log(x21) + 11.3760018455292*log(x22)) + x34 =E= 0;
