...
maximize obj: 0.95*log(x12) + 0.9025*log(x13) + 0.857375*log(x14) + 0.81450625*
    log(x15) + 0.7737809375*log(x16) + 0.735091890625*log(x17) + 
...
e1: 0.759835685651592*x1**0.25 - x12 - x23 = 0;
...
e7: 0.867934991180341*x7**0.25 - x18 - x29 = 0;

e8: 0.88739119671479*x8**0.25 - x19 - x30 = 0;

e9: 0.907283545436971*x9**0.25 - x20 - x31 = 0;
