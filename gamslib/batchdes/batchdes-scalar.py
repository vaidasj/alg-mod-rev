...
m.x17 = Var(within=Reals,bounds=(0,1.09861228866811),initialize=1.09861228866811)
m.x18 = Var(within=Reals,bounds=(0,1.09861228866811),initialize=1.09861228866811)
m.x19 = Var(within=Reals,bounds=(0,1.09861228866811),initialize=1.09861228866811)
...
m.c20 = Constraint(expr=-(250*exp(0.6*m.x10 + m.x17) + 500*exp(0.6*m.x11 + m.x18) + 340*exp(0.6*m.x12 + m.x19)) + m.x20
                         >= 0)
