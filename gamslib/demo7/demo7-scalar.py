...
m.x1 = Var(within=Reals,bounds=(0,None),initialize=756.650246305419)
m.x2 = Var(within=Reals,bounds=(0,None),initialize=551.724137931034)
m.x3 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x4 = Var(within=Reals,bounds=(0,None),initialize=2001.97044334975)
m.x5 = Var(within=Reals,bounds=(0,None),initialize=1241.37931034483)
m.x6 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x7 = Var(within=Reals,bounds=(0,None),initialize=2068.96551724138)
m.x8 = Var(within=Reals,bounds=(None,None),initialize=1472022.69950739)
m.x9 = Var(within=Reals,bounds=(None,None),initialize=2260788.1773399)
m.x10 = Var(within=Reals,bounds=(None,None),initialize=310423.645320197)
m.x11 = Var(within=Reals,bounds=(None,None),initialize=0)
m.x12 = Var(within=Reals,bounds=(None,None),initialize=478341.832512315)
m.x13 = Var(within=Reals,bounds=(None,None),initialize=900000)
m.x14 = Var(within=Reals,bounds=(None,None),initialize=1688765.47783251)
m.x15 = Var(within=Reals,bounds=(0,25000),initialize=25000)
m.x16 = Var(within=Reals,bounds=(0,25000),initialize=25000)
m.x17 = Var(within=Reals,bounds=(0,25000),initialize=25000)
m.x18 = Var(within=Reals,bounds=(0,25000),initialize=25000)
m.x19 = Var(within=Reals,bounds=(0,25000),initialize=25000)
m.x20 = Var(within=Reals,bounds=(0,25000),initialize=25000)
m.x21 = Var(within=Reals,bounds=(0,25000),initialize=25000)
m.x22 = Var(within=Reals,bounds=(0,25000),initialize=25000)
m.x23 = Var(within=Reals,bounds=(0,25000),initialize=25000)
m.x24 = Var(within=Reals,bounds=(0,25000),initialize=25000)
m.x25 = Var(within=Reals,bounds=(0,25000),initialize=25000)
m.x26 = Var(within=Reals,bounds=(0,25000),initialize=25000)
m.x27 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x28 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x29 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x30 = Var(within=Reals,bounds=(0,None),initialize=24472.4729064039)
m.x31 = Var(within=Reals,bounds=(0,None),initialize=7311.64532019704)
m.x32 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x33 = Var(within=Reals,bounds=(0,None),initialize=15344.8275862069)
m.x34 = Var(within=Reals,bounds=(0,None),initialize=11827.5862068966)
m.x35 = Var(within=Reals,bounds=(0,None),initialize=4379.31034482759)
m.x36 = Var(within=Reals,bounds=(0,None),initialize=25068.9655172414)
m.x37 = Var(within=Reals,bounds=(0,None),initialize=31180.6502463054)
m.x38 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x39 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x40 = Var(within=Reals,bounds=(0,None),initialize=1655.1724137931)
m.x41 = Var(within=Reals,bounds=(0,None),initialize=1134.97536945813)
m.x42 = Var(within=Reals,bounds=(0,None),initialize=3310.34482758621)
m.x43 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x44 = Var(within=Reals,bounds=(0,None),initialize=6005.91133004926)
m.x45 = Var(within=Reals,bounds=(0,None),initialize=1862.06896551724)
m.x46 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x47 = Var(within=Reals,bounds=(0,None),initialize=6206.89655172414)
m.x48 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x49 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x50 = Var(within=Reals,bounds=(0,None),initialize=1134.97536945813)
m.x51 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x52 = Var(within=Reals,bounds=(0,None),initialize=6005.91133004926)
m.x53 = Var(within=Reals,bounds=(0,None),initialize=1862.06896551724)
m.x54 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x55 = Var(within=Reals,bounds=(0,None),initialize=6206.89655172414)
...
m.x69 = Var(within=Reals,bounds=(None,None),initialize=2260788.1773399)
m.x70 = Var(within=Reals,bounds=(None,None),initialize=1133.15599343186)
m.x71 = Var(within=Reals,bounds=(None,None),initialize=0)

m.obj = Objective(expr=225*m.x50 - 0.0231481481481481*m.x50**2 + 700*m.x51 - 0.277777777777778*m.x51**2 + 250*m.x52 - 
                       0.0892857142857143*m.x52**2 + 700*m.x53 - 0.0833333333333333*m.x53**2 + 210*m.x54 - 
                       0.0184210526315789*m.x54**2 + 220*m.x55 - 0.1*m.x55**2 - m.x14 + 40*m.x62 + 300*m.x63 + 60*m.x64
                        - 140*m.x65 - 270*m.x66 - 85*m.x67, sense=maximize)
...
m.c28 = Constraint(expr=-(225*m.x50 - 0.0462962962962963*m.x50**2 + 700*m.x51 - 0.555555555555555*m.x51**2 + 250*m.x52
                         - 0.178571428571429*m.x52**2 + 700*m.x53 - 0.166666666666667*m.x53**2 + 210*m.x54 - 
                        0.0368421052631579*m.x54**2 + 220*m.x55 - 0.2*m.x55**2) + m.x9 - 40*m.x62 - 300*m.x63 - 60*m.x64
                         == 0)
