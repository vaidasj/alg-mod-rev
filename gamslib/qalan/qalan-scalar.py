...
m.x1 = Var(within=Reals,bounds=(0,None),initialize=0.302884615384616)
m.x2 = Var(within=Reals,bounds=(0,None),initialize=0.0865384615384613)
m.x3 = Var(within=Reals,bounds=(0,None),initialize=0.504807692307692)
m.x4 = Var(within=Reals,bounds=(0,None),initialize=0.105769230769231)
