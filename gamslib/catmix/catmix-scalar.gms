...
*       1203        3     1200        0
*
*  Solve m using NLP minimizing x304;
...
e11.. x112 - (0.005*(x10*(10*x212 - x111) + x11*(10*x213 - x112)) + x111) =E= 0
      ;

e12.. x113 - (0.005*(x11*(10*x213 - x112) + x12*(10*x214 - x113)) + x112) =E= 0
      ;

e13.. x114 - (0.005*(x12*(10*x214 - x113) + x13*(10*x215 - x114)) + x113) =E= 0
      ;

e14.. x115 - (0.005*(x13*(10*x215 - x114) + x14*(10*x216 - x115)) + x114) =E= 0
      ;

e15.. x116 - (0.005*(x14*(10*x216 - x115) + x15*(10*x217 - x116)) + x115) =E= 0
      ;

e16.. x117 - (0.005*(x15*(10*x217 - x116) + x16*(10*x218 - x117)) + x116) =E= 0
      ;

e17.. x118 - (0.005*(x16*(10*x218 - x117) + x17*(10*x219 - x118)) + x117) =E= 0
      ;

e18.. x119 - (0.005*(x17*(10*x219 - x118) + x18*(10*x220 - x119)) + x118) =E= 0
      ;

e19.. x120 - (0.005*(x18*(10*x220 - x119) + x19*(10*x221 - x120)) + x119) =E= 0
      ;

e20.. x121 - (0.005*(x19*(10*x221 - x120) + x20*(10*x222 - x121)) + x120) =E= 0
      ;

e21.. x122 - (0.005*(x20*(10*x222 - x121) + x21*(10*x223 - x122)) + x121) =E= 0
      ;

e22.. x123 - (0.005*(x21*(10*x223 - x122) + x22*(10*x224 - x123)) + x122) =E= 0
      ;

e23.. x124 - (0.005*(x22*(10*x224 - x123) + x23*(10*x225 - x124)) + x123) =E= 0
      ;

e24.. x125 - (0.005*(x23*(10*x225 - x124) + x24*(10*x226 - x125)) + x124) =E= 0
      ;

e25.. x126 - (0.005*(x24*(10*x226 - x125) + x25*(10*x227 - x126)) + x125) =E= 0
      ;

e26.. x127 - (0.005*(x25*(10*x227 - x126) + x26*(10*x228 - x127)) + x126) =E= 0
      ;

e27.. x128 - (0.005*(x26*(10*x228 - x127) + x27*(10*x229 - x128)) + x127) =E= 0
      ;

e28.. x129 - (0.005*(x27*(10*x229 - x128) + x28*(10*x230 - x129)) + x128) =E= 0
      ;

e29.. x130 - (0.005*(x28*(10*x230 - x129) + x29*(10*x231 - x130)) + x129) =E= 0
      ;

e30.. x131 - (0.005*(x29*(10*x231 - x130) + x30*(10*x232 - x131)) + x130) =E= 0
      ;

e31.. x132 - (0.005*(x30*(10*x232 - x131) + x31*(10*x233 - x132)) + x131) =E= 0
      ;

e32.. x133 - (0.005*(x31*(10*x233 - x132) + x32*(10*x234 - x133)) + x132) =E= 0
      ;

e33.. x134 - (0.005*(x32*(10*x234 - x133) + x33*(10*x235 - x134)) + x133) =E= 0
      ;

e34.. x135 - (0.005*(x33*(10*x235 - x134) + x34*(10*x236 - x135)) + x134) =E= 0
      ;

e35.. x136 - (0.005*(x34*(10*x236 - x135) + x35*(10*x237 - x136)) + x135) =E= 0
      ;

e36.. x137 - (0.005*(x35*(10*x237 - x136) + x36*(10*x238 - x137)) + x136) =E= 0
      ;

e37.. x138 - (0.005*(x36*(10*x238 - x137) + x37*(10*x239 - x138)) + x137) =E= 0
      ;

e38.. x139 - (0.005*(x37*(10*x239 - x138) + x38*(10*x240 - x139)) + x138) =E= 0
      ;

e39.. x140 - (0.005*(x38*(10*x240 - x139) + x39*(10*x241 - x140)) + x139) =E= 0
      ;

e40.. x141 - (0.005*(x39*(10*x241 - x140) + x40*(10*x242 - x141)) + x140) =E= 0
      ;

e41.. x142 - (0.005*(x40*(10*x242 - x141) + x41*(10*x243 - x142)) + x141) =E= 0
      ;

e42.. x143 - (0.005*(x41*(10*x243 - x142) + x42*(10*x244 - x143)) + x142) =E= 0
      ;

e43.. x144 - (0.005*(x42*(10*x244 - x143) + x43*(10*x245 - x144)) + x143) =E= 0
      ;

e44.. x145 - (0.005*(x43*(10*x245 - x144) + x44*(10*x246 - x145)) + x144) =E= 0
      ;

e45.. x146 - (0.005*(x44*(10*x246 - x145) + x45*(10*x247 - x146)) + x145) =E= 0
      ;

e46.. x147 - (0.005*(x45*(10*x247 - x146) + x46*(10*x248 - x147)) + x146) =E= 0
      ;

e47.. x148 - (0.005*(x46*(10*x248 - x147) + x47*(10*x249 - x148)) + x147) =E= 0
      ;

e48.. x149 - (0.005*(x47*(10*x249 - x148) + x48*(10*x250 - x149)) + x148) =E= 0
      ;

e49.. x150 - (0.005*(x48*(10*x250 - x149) + x49*(10*x251 - x150)) + x149) =E= 0
      ;

e50.. x151 - (0.005*(x49*(10*x251 - x150) + x50*(10*x252 - x151)) + x150) =E= 0
      ;

e51.. x152 - (0.005*(x50*(10*x252 - x151) + x51*(10*x253 - x152)) + x151) =E= 0
      ;

e52.. x153 - (0.005*(x51*(10*x253 - x152) + x52*(10*x254 - x153)) + x152) =E= 0
      ;

e53.. x154 - (0.005*(x52*(10*x254 - x153) + x53*(10*x255 - x154)) + x153) =E= 0
      ;

e54.. x155 - (0.005*(x53*(10*x255 - x154) + x54*(10*x256 - x155)) + x154) =E= 0
      ;

e55.. x156 - (0.005*(x54*(10*x256 - x155) + x55*(10*x257 - x156)) + x155) =E= 0
      ;

e56.. x157 - (0.005*(x55*(10*x257 - x156) + x56*(10*x258 - x157)) + x156) =E= 0
      ;

e57.. x158 - (0.005*(x56*(10*x258 - x157) + x57*(10*x259 - x158)) + x157) =E= 0
      ;

e58.. x159 - (0.005*(x57*(10*x259 - x158) + x58*(10*x260 - x159)) + x158) =E= 0
      ;

e59.. x160 - (0.005*(x58*(10*x260 - x159) + x59*(10*x261 - x160)) + x159) =E= 0
      ;

e60.. x161 - (0.005*(x59*(10*x261 - x160) + x60*(10*x262 - x161)) + x160) =E= 0
      ;

e61.. x162 - (0.005*(x60*(10*x262 - x161) + x61*(10*x263 - x162)) + x161) =E= 0
      ;

e62.. x163 - (0.005*(x61*(10*x263 - x162) + x62*(10*x264 - x163)) + x162) =E= 0
      ;

e63.. x164 - (0.005*(x62*(10*x264 - x163) + x63*(10*x265 - x164)) + x163) =E= 0
      ;

e64.. x165 - (0.005*(x63*(10*x265 - x164) + x64*(10*x266 - x165)) + x164) =E= 0
      ;

e65.. x166 - (0.005*(x64*(10*x266 - x165) + x65*(10*x267 - x166)) + x165) =E= 0
      ;

e66.. x167 - (0.005*(x65*(10*x267 - x166) + x66*(10*x268 - x167)) + x166) =E= 0
      ;

e67.. x168 - (0.005*(x66*(10*x268 - x167) + x67*(10*x269 - x168)) + x167) =E= 0
      ;

e68.. x169 - (0.005*(x67*(10*x269 - x168) + x68*(10*x270 - x169)) + x168) =E= 0
      ;

e69.. x170 - (0.005*(x68*(10*x270 - x169) + x69*(10*x271 - x170)) + x169) =E= 0
      ;

e70.. x171 - (0.005*(x69*(10*x271 - x170) + x70*(10*x272 - x171)) + x170) =E= 0
      ;

e71.. x172 - (0.005*(x70*(10*x272 - x171) + x71*(10*x273 - x172)) + x171) =E= 0
      ;

e72.. x173 - (0.005*(x71*(10*x273 - x172) + x72*(10*x274 - x173)) + x172) =E= 0
      ;

e73.. x174 - (0.005*(x72*(10*x274 - x173) + x73*(10*x275 - x174)) + x173) =E= 0
      ;

e74.. x175 - (0.005*(x73*(10*x275 - x174) + x74*(10*x276 - x175)) + x174) =E= 0
      ;

e75.. x176 - (0.005*(x74*(10*x276 - x175) + x75*(10*x277 - x176)) + x175) =E= 0
      ;

e76.. x177 - (0.005*(x75*(10*x277 - x176) + x76*(10*x278 - x177)) + x176) =E= 0
      ;

e77.. x178 - (0.005*(x76*(10*x278 - x177) + x77*(10*x279 - x178)) + x177) =E= 0
      ;

e78.. x179 - (0.005*(x77*(10*x279 - x178) + x78*(10*x280 - x179)) + x178) =E= 0
      ;

e79.. x180 - (0.005*(x78*(10*x280 - x179) + x79*(10*x281 - x180)) + x179) =E= 0
      ;

e80.. x181 - (0.005*(x79*(10*x281 - x180) + x80*(10*x282 - x181)) + x180) =E= 0
      ;

e81.. x182 - (0.005*(x80*(10*x282 - x181) + x81*(10*x283 - x182)) + x181) =E= 0
      ;

e82.. x183 - (0.005*(x81*(10*x283 - x182) + x82*(10*x284 - x183)) + x182) =E= 0
      ;

e83.. x184 - (0.005*(x82*(10*x284 - x183) + x83*(10*x285 - x184)) + x183) =E= 0
      ;

e84.. x185 - (0.005*(x83*(10*x285 - x184) + x84*(10*x286 - x185)) + x184) =E= 0
      ;

e85.. x186 - (0.005*(x84*(10*x286 - x185) + x85*(10*x287 - x186)) + x185) =E= 0
      ;

e86.. x187 - (0.005*(x85*(10*x287 - x186) + x86*(10*x288 - x187)) + x186) =E= 0
      ;

e87.. x188 - (0.005*(x86*(10*x288 - x187) + x87*(10*x289 - x188)) + x187) =E= 0
      ;

e88.. x189 - (0.005*(x87*(10*x289 - x188) + x88*(10*x290 - x189)) + x188) =E= 0
      ;

e89.. x190 - (0.005*(x88*(10*x290 - x189) + x89*(10*x291 - x190)) + x189) =E= 0
      ;

e90.. x191 - (0.005*(x89*(10*x291 - x190) + x90*(10*x292 - x191)) + x190) =E= 0
      ;

e91.. x192 - (0.005*(x90*(10*x292 - x191) + x91*(10*x293 - x192)) + x191) =E= 0
      ;

e92.. x193 - (0.005*(x91*(10*x293 - x192) + x92*(10*x294 - x193)) + x192) =E= 0
      ;

e93.. x194 - (0.005*(x92*(10*x294 - x193) + x93*(10*x295 - x194)) + x193) =E= 0
      ;

e94.. x195 - (0.005*(x93*(10*x295 - x194) + x94*(10*x296 - x195)) + x194) =E= 0
      ;

e95.. x196 - (0.005*(x94*(10*x296 - x195) + x95*(10*x297 - x196)) + x195) =E= 0
      ;

e96.. x197 - (0.005*(x95*(10*x297 - x196) + x96*(10*x298 - x197)) + x196) =E= 0
      ;

e97.. x198 - (0.005*(x96*(10*x298 - x197) + x97*(10*x299 - x198)) + x197) =E= 0
      ;

e98.. x199 - (0.005*(x97*(10*x299 - x198) + x98*(10*x300 - x199)) + x198) =E= 0
      ;

e99.. x200 - (0.005*(x98*(10*x300 - x199) + x99*(10*x301 - x200)) + x199) =E= 0
      ;
