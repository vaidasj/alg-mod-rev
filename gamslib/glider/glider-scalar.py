#  NLP written by GAMS Convert at 12/13/18 11:22:33
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#        610      610        0        0        0        0        0        0
...
m.x4 = Var(within=Reals,bounds=(0,None),initialize=0.5292)
m.x5 = Var(within=Reals,bounds=(0,None),initialize=0.7938)
m.x6 = Var(within=Reals,bounds=(0,None),initialize=1.0584)
m.x7 = Var(within=Reals,bounds=(0,None),initialize=1.323)
m.x8 = Var(within=Reals,bounds=(0,None),initialize=1.5876)
m.x9 = Var(within=Reals,bounds=(0,None),initialize=1.8522)
m.x10 = Var(within=Reals,bounds=(0,None),initialize=2.1168)
m.x11 = Var(within=Reals,bounds=(0,None),initialize=2.3814)
m.x12 = Var(within=Reals,bounds=(0,None),initialize=2.646)
m.x13 = Var(within=Reals,bounds=(0,None),initialize=2.9106)
m.x14 = Var(within=Reals,bounds=(0,None),initialize=3.1752)
m.x15 = Var(within=Reals,bounds=(0,None),initialize=3.4398)
m.x16 = Var(within=Reals,bounds=(0,None),initialize=3.7044)
m.x17 = Var(within=Reals,bounds=(0,None),initialize=3.969)
m.x18 = Var(within=Reals,bounds=(0,None),initialize=4.2336)
m.x19 = Var(within=Reals,bounds=(0,None),initialize=4.4982)
m.x20 = Var(within=Reals,bounds=(0,None),initialize=4.7628)
m.x21 = Var(within=Reals,bounds=(0,None),initialize=5.0274)
m.x22 = Var(within=Reals,bounds=(0,None),initialize=5.292)
m.x23 = Var(within=Reals,bounds=(0,None),initialize=5.5566)
m.x24 = Var(within=Reals,bounds=(0,None),initialize=5.8212)
m.x25 = Var(within=Reals,bounds=(0,None),initialize=6.0858)
m.x26 = Var(within=Reals,bounds=(0,None),initialize=6.3504)
m.x27 = Var(within=Reals,bounds=(0,None),initialize=6.615)
m.x28 = Var(within=Reals,bounds=(0,None),initialize=6.8796)
m.x29 = Var(within=Reals,bounds=(0,None),initialize=7.1442)
m.x30 = Var(within=Reals,bounds=(0,None),initialize=7.4088)
m.x31 = Var(within=Reals,bounds=(0,None),initialize=7.6734)
m.x32 = Var(within=Reals,bounds=(0,None),initialize=7.938)
m.x33 = Var(within=Reals,bounds=(0,None),initialize=8.2026)
m.x34 = Var(within=Reals,bounds=(0,None),initialize=8.4672)
m.x35 = Var(within=Reals,bounds=(0,None),initialize=8.7318)
m.x36 = Var(within=Reals,bounds=(0,None),initialize=8.9964)
m.x37 = Var(within=Reals,bounds=(0,None),initialize=9.261)
m.x38 = Var(within=Reals,bounds=(0,None),initialize=9.5256)
m.x39 = Var(within=Reals,bounds=(0,None),initialize=9.7902)
m.x40 = Var(within=Reals,bounds=(0,None),initialize=10.0548)
m.x41 = Var(within=Reals,bounds=(0,None),initialize=10.3194)
m.x42 = Var(within=Reals,bounds=(0,None),initialize=10.584)
m.x43 = Var(within=Reals,bounds=(0,None),initialize=10.8486)
m.x44 = Var(within=Reals,bounds=(0,None),initialize=11.1132)
m.x45 = Var(within=Reals,bounds=(0,None),initialize=11.3778)
m.x46 = Var(within=Reals,bounds=(0,None),initialize=11.6424)
m.x47 = Var(within=Reals,bounds=(0,None),initialize=11.907)
m.x48 = Var(within=Reals,bounds=(0,None),initialize=12.1716)
m.x49 = Var(within=Reals,bounds=(0,None),initialize=12.4362)
m.x50 = Var(within=Reals,bounds=(0,None),initialize=12.7008)
m.x51 = Var(within=Reals,bounds=(0,None),initialize=12.9654)
m.x52 = Var(within=Reals,bounds=(0,None),initialize=13.23)
m.x53 = Var(within=Reals,bounds=(1000,1000),initialize=1000)
m.x54 = Var(within=Reals,bounds=(None,None),initialize=998)
m.x55 = Var(within=Reals,bounds=(None,None),initialize=996)
m.x56 = Var(within=Reals,bounds=(None,None),initialize=994)
m.x57 = Var(within=Reals,bounds=(None,None),initialize=992)
m.x58 = Var(within=Reals,bounds=(None,None),initialize=990)
m.x59 = Var(within=Reals,bounds=(None,None),initialize=988)
m.x60 = Var(within=Reals,bounds=(None,None),initialize=986)
m.x61 = Var(within=Reals,bounds=(None,None),initialize=984)
m.x62 = Var(within=Reals,bounds=(None,None),initialize=982)
m.x63 = Var(within=Reals,bounds=(None,None),initialize=980)
m.x64 = Var(within=Reals,bounds=(None,None),initialize=978)
m.x65 = Var(within=Reals,bounds=(None,None),initialize=976)
m.x66 = Var(within=Reals,bounds=(None,None),initialize=974)
m.x67 = Var(within=Reals,bounds=(None,None),initialize=972)
m.x68 = Var(within=Reals,bounds=(None,None),initialize=970)
m.x69 = Var(within=Reals,bounds=(None,None),initialize=968)
m.x70 = Var(within=Reals,bounds=(None,None),initialize=966)
m.x71 = Var(within=Reals,bounds=(None,None),initialize=964)
m.x72 = Var(within=Reals,bounds=(None,None),initialize=962)
m.x73 = Var(within=Reals,bounds=(None,None),initialize=960)
m.x74 = Var(within=Reals,bounds=(None,None),initialize=958)
m.x75 = Var(within=Reals,bounds=(None,None),initialize=956)
m.x76 = Var(within=Reals,bounds=(None,None),initialize=954)
m.x77 = Var(within=Reals,bounds=(None,None),initialize=952)
m.x78 = Var(within=Reals,bounds=(None,None),initialize=950)
m.x79 = Var(within=Reals,bounds=(None,None),initialize=948)
m.x80 = Var(within=Reals,bounds=(None,None),initialize=946)
m.x81 = Var(within=Reals,bounds=(None,None),initialize=944)
m.x82 = Var(within=Reals,bounds=(None,None),initialize=942)
m.x83 = Var(within=Reals,bounds=(None,None),initialize=940)
m.x84 = Var(within=Reals,bounds=(None,None),initialize=938)
m.x85 = Var(within=Reals,bounds=(None,None),initialize=936)
m.x86 = Var(within=Reals,bounds=(None,None),initialize=934)
m.x87 = Var(within=Reals,bounds=(None,None),initialize=932)
m.x88 = Var(within=Reals,bounds=(None,None),initialize=930)
m.x89 = Var(within=Reals,bounds=(None,None),initialize=928)
m.x90 = Var(within=Reals,bounds=(None,None),initialize=926)
m.x91 = Var(within=Reals,bounds=(None,None),initialize=924)
m.x92 = Var(within=Reals,bounds=(None,None),initialize=922)
m.x93 = Var(within=Reals,bounds=(None,None),initialize=920)
m.x94 = Var(within=Reals,bounds=(None,None),initialize=918)
m.x95 = Var(within=Reals,bounds=(None,None),initialize=916)
m.x96 = Var(within=Reals,bounds=(None,None),initialize=914)
m.x97 = Var(within=Reals,bounds=(None,None),initialize=912)
m.x98 = Var(within=Reals,bounds=(None,None),initialize=910)
m.x99 = Var(within=Reals,bounds=(None,None),initialize=908)
m.x100 = Var(within=Reals,bounds=(None,None),initialize=906)
m.x101 = Var(within=Reals,bounds=(None,None),initialize=904)
m.x102 = Var(within=Reals,bounds=(None,None),initialize=902)
...
m.x257 = Var(within=Reals,bounds=(None,None),initialize=6.25)
m.x258 = Var(within=Reals,bounds=(None,None),initialize=6.236777001316)
m.x259 = Var(within=Reals,bounds=(None,None),initialize=6.223568005264)
m.x260 = Var(within=Reals,bounds=(None,None),initialize=6.210373011844)
m.x261 = Var(within=Reals,bounds=(None,None),initialize=6.197192021056)
m.x262 = Var(within=Reals,bounds=(None,None),initialize=6.1840250329)
m.x263 = Var(within=Reals,bounds=(None,None),initialize=6.170872047376)
m.x264 = Var(within=Reals,bounds=(None,None),initialize=6.157733064484)
m.x265 = Var(within=Reals,bounds=(None,None),initialize=6.144608084224)
m.x266 = Var(within=Reals,bounds=(None,None),initialize=6.131497106596)
m.x267 = Var(within=Reals,bounds=(None,None),initialize=6.1184001316)
m.x268 = Var(within=Reals,bounds=(None,None),initialize=6.105317159236)
m.x269 = Var(within=Reals,bounds=(None,None),initialize=6.092248189504)
m.x270 = Var(within=Reals,bounds=(None,None),initialize=6.079193222404)
m.x271 = Var(within=Reals,bounds=(None,None),initialize=6.066152257936)
m.x272 = Var(within=Reals,bounds=(None,None),initialize=6.0531252961)
m.x273 = Var(within=Reals,bounds=(None,None),initialize=6.040112336896)
m.x274 = Var(within=Reals,bounds=(None,None),initialize=6.027113380324)
m.x275 = Var(within=Reals,bounds=(None,None),initialize=6.014128426384)
m.x276 = Var(within=Reals,bounds=(None,None),initialize=6.001157475076)
m.x277 = Var(within=Reals,bounds=(None,None),initialize=5.9882005264)
m.x278 = Var(within=Reals,bounds=(None,None),initialize=5.975257580356)
m.x279 = Var(within=Reals,bounds=(None,None),initialize=5.962328636944)
m.x280 = Var(within=Reals,bounds=(None,None),initialize=5.949413696164)
m.x281 = Var(within=Reals,bounds=(None,None),initialize=5.936512758016)
m.x282 = Var(within=Reals,bounds=(None,None),initialize=5.9236258225)
m.x283 = Var(within=Reals,bounds=(None,None),initialize=5.910752889616)
m.x284 = Var(within=Reals,bounds=(None,None),initialize=5.897893959364)
m.x285 = Var(within=Reals,bounds=(None,None),initialize=5.885049031744)
m.x286 = Var(within=Reals,bounds=(None,None),initialize=5.872218106756)
m.x287 = Var(within=Reals,bounds=(None,None),initialize=5.8594011844)
m.x288 = Var(within=Reals,bounds=(None,None),initialize=5.846598264676)
m.x289 = Var(within=Reals,bounds=(None,None),initialize=5.833809347584)
m.x290 = Var(within=Reals,bounds=(None,None),initialize=5.821034433124)
m.x291 = Var(within=Reals,bounds=(None,None),initialize=5.808273521296)
m.x292 = Var(within=Reals,bounds=(None,None),initialize=5.7955266121)
m.x293 = Var(within=Reals,bounds=(None,None),initialize=5.782793705536)
m.x294 = Var(within=Reals,bounds=(None,None),initialize=5.770074801604)
m.x295 = Var(within=Reals,bounds=(None,None),initialize=5.757369900304)
m.x296 = Var(within=Reals,bounds=(None,None),initialize=5.744679001636)
m.x297 = Var(within=Reals,bounds=(None,None),initialize=5.7320021056)
m.x298 = Var(within=Reals,bounds=(None,None),initialize=5.719339212196)
m.x299 = Var(within=Reals,bounds=(None,None),initialize=5.706690321424)
m.x300 = Var(within=Reals,bounds=(None,None),initialize=5.694055433284)
m.x301 = Var(within=Reals,bounds=(None,None),initialize=5.681434547776)
m.x302 = Var(within=Reals,bounds=(None,None),initialize=5.6688276649)
m.x303 = Var(within=Reals,bounds=(None,None),initialize=5.656234784656)
m.x304 = Var(within=Reals,bounds=(None,None),initialize=5.643655907044)
m.x305 = Var(within=Reals,bounds=(None,None),initialize=5.631091032064)
m.x306 = Var(within=Reals,bounds=(None,None),initialize=5.618540159716)
m.x307 = Var(within=Reals,bounds=(None,None),initialize=5.60600329)
m.x308 = Var(within=Reals,bounds=(None,None),initialize=-0.0253372105379887)
m.x309 = Var(within=Reals,bounds=(None,None),initialize=-0.0256098038880829)
m.x310 = Var(within=Reals,bounds=(None,None),initialize=-0.0258848718578717)
m.x311 = Var(within=Reals,bounds=(None,None),initialize=-0.0261624309260197)
m.x312 = Var(within=Reals,bounds=(None,None),initialize=-0.0264424976034241)
m.x313 = Var(within=Reals,bounds=(None,None),initialize=-0.026725088432124)
m.x314 = Var(within=Reals,bounds=(None,None),initialize=-0.0270102199841911)
m.x315 = Var(within=Reals,bounds=(None,None),initialize=-0.0272979088606009)
m.x316 = Var(within=Reals,bounds=(None,None),initialize=-0.0275881716900862)
m.x317 = Var(within=Reals,bounds=(None,None),initialize=-0.02788102512797)
m.x318 = Var(within=Reals,bounds=(None,None),initialize=-0.0281764858549801)
m.x319 = Var(within=Reals,bounds=(None,None),initialize=-0.0284745705760444)
m.x320 = Var(within=Reals,bounds=(None,None),initialize=-0.0287752960190664)
m.x321 = Var(within=Reals,bounds=(None,None),initialize=-0.0290786789336809)
m.x322 = Var(within=Reals,bounds=(None,None),initialize=-0.0293847360899904)
m.x323 = Var(within=Reals,bounds=(None,None),initialize=-0.0296934842772818)
m.x324 = Var(within=Reals,bounds=(None,None),initialize=-0.0300049403027224)
m.x325 = Var(within=Reals,bounds=(None,None),initialize=-0.0303191209900359)
m.x326 = Var(within=Reals,bounds=(None,None),initialize=-0.0306360431781595)
m.x327 = Var(within=Reals,bounds=(None,None),initialize=-0.0309557237198784)
m.x328 = Var(within=Reals,bounds=(None,None),initialize=-0.031278179480442)
m.x329 = Var(within=Reals,bounds=(None,None),initialize=-0.0316034273361579)
m.x330 = Var(within=Reals,bounds=(None,None),initialize=-0.0319314841729662)
m.x331 = Var(within=Reals,bounds=(None,None),initialize=-0.0322623668849924)
m.x332 = Var(within=Reals,bounds=(None,None),initialize=-0.0325960923730796)
m.x333 = Var(within=Reals,bounds=(None,None),initialize=-0.0329326775432998)
m.x334 = Var(within=Reals,bounds=(None,None),initialize=-0.0332721393054434)
m.x335 = Var(within=Reals,bounds=(None,None),initialize=-0.0336144945714882)
m.x336 = Var(within=Reals,bounds=(None,None),initialize=-0.0339597602540464)
m.x337 = Var(within=Reals,bounds=(None,None),initialize=-0.0343079532647903)
m.x338 = Var(within=Reals,bounds=(None,None),initialize=-0.0346590905128567)
m.x339 = Var(within=Reals,bounds=(None,None),initialize=-0.0350131889032288)
m.x340 = Var(within=Reals,bounds=(None,None),initialize=-0.035370265335097)
m.x341 = Var(within=Reals,bounds=(None,None),initialize=-0.0357303367001974)
m.x342 = Var(within=Reals,bounds=(None,None),initialize=-0.0360934198811282)
m.x343 = Var(within=Reals,bounds=(None,None),initialize=-0.0364595317496441)
m.x344 = Var(within=Reals,bounds=(None,None),initialize=-0.0368286891649289)
m.x345 = Var(within=Reals,bounds=(None,None),initialize=-0.0372009089718442)
m.x346 = Var(within=Reals,bounds=(None,None),initialize=-0.0375762079991578)
m.x347 = Var(within=Reals,bounds=(None,None),initialize=-0.0379546030577479)
m.x348 = Var(within=Reals,bounds=(None,None),initialize=-0.0383361109387851)
m.x349 = Var(within=Reals,bounds=(None,None),initialize=-0.038720748411892)
m.x350 = Var(within=Reals,bounds=(None,None),initialize=-0.0391085322232799)
m.x351 = Var(within=Reals,bounds=(None,None),initialize=-0.039499479093862)
m.x352 = Var(within=Reals,bounds=(None,None),initialize=-0.0398936057173445)
m.x353 = Var(within=Reals,bounds=(None,None),initialize=-0.0402909287582937)
m.x354 = Var(within=Reals,bounds=(None,None),initialize=-0.0406914648501804)
m.x355 = Var(within=Reals,bounds=(None,None),initialize=-0.0410952305934013)
m.x356 = Var(within=Reals,bounds=(None,None),initialize=-0.0415022425532763)
m.x357 = Var(within=Reals,bounds=(None,None),initialize=-0.0419125172580233)
m.x358 = Var(within=Reals,bounds=(None,None),initialize=-0.0423260711967084)
m.x359 = Var(within=Reals,bounds=(None,None),initialize=-1.26266278946201)
m.x360 = Var(within=Reals,bounds=(None,None),initialize=-1.26239019611192)
m.x361 = Var(within=Reals,bounds=(None,None),initialize=-1.26211512814213)
m.x362 = Var(within=Reals,bounds=(None,None),initialize=-1.26183756907398)
m.x363 = Var(within=Reals,bounds=(None,None),initialize=-1.26155750239658)
m.x364 = Var(within=Reals,bounds=(None,None),initialize=-1.26127491156788)
m.x365 = Var(within=Reals,bounds=(None,None),initialize=-1.26098978001581)
m.x366 = Var(within=Reals,bounds=(None,None),initialize=-1.2607020911394)
m.x367 = Var(within=Reals,bounds=(None,None),initialize=-1.26041182830991)
m.x368 = Var(within=Reals,bounds=(None,None),initialize=-1.26011897487203)
m.x369 = Var(within=Reals,bounds=(None,None),initialize=-1.25982351414502)
m.x370 = Var(within=Reals,bounds=(None,None),initialize=-1.25952542942396)
m.x371 = Var(within=Reals,bounds=(None,None),initialize=-1.25922470398093)
m.x372 = Var(within=Reals,bounds=(None,None),initialize=-1.25892132106632)
m.x373 = Var(within=Reals,bounds=(None,None),initialize=-1.25861526391001)
m.x374 = Var(within=Reals,bounds=(None,None),initialize=-1.25830651572272)
m.x375 = Var(within=Reals,bounds=(None,None),initialize=-1.25799505969728)
m.x376 = Var(within=Reals,bounds=(None,None),initialize=-1.25768087900996)
m.x377 = Var(within=Reals,bounds=(None,None),initialize=-1.25736395682184)
m.x378 = Var(within=Reals,bounds=(None,None),initialize=-1.25704427628012)
m.x379 = Var(within=Reals,bounds=(None,None),initialize=-1.25672182051956)
m.x380 = Var(within=Reals,bounds=(None,None),initialize=-1.25639657266384)
m.x381 = Var(within=Reals,bounds=(None,None),initialize=-1.25606851582703)
m.x382 = Var(within=Reals,bounds=(None,None),initialize=-1.25573763311501)
m.x383 = Var(within=Reals,bounds=(None,None),initialize=-1.25540390762692)
m.x384 = Var(within=Reals,bounds=(None,None),initialize=-1.2550673224567)
m.x385 = Var(within=Reals,bounds=(None,None),initialize=-1.25472786069456)
m.x386 = Var(within=Reals,bounds=(None,None),initialize=-1.25438550542851)
m.x387 = Var(within=Reals,bounds=(None,None),initialize=-1.25404023974595)
m.x388 = Var(within=Reals,bounds=(None,None),initialize=-1.25369204673521)
m.x389 = Var(within=Reals,bounds=(None,None),initialize=-1.25334090948714)
m.x390 = Var(within=Reals,bounds=(None,None),initialize=-1.25298681109677)
m.x391 = Var(within=Reals,bounds=(None,None),initialize=-1.2526297346649)
m.x392 = Var(within=Reals,bounds=(None,None),initialize=-1.2522696632998)
m.x393 = Var(within=Reals,bounds=(None,None),initialize=-1.25190658011887)
m.x394 = Var(within=Reals,bounds=(None,None),initialize=-1.25154046825036)
m.x395 = Var(within=Reals,bounds=(None,None),initialize=-1.25117131083507)
m.x396 = Var(within=Reals,bounds=(None,None),initialize=-1.25079909102816)
m.x397 = Var(within=Reals,bounds=(None,None),initialize=-1.25042379200084)
m.x398 = Var(within=Reals,bounds=(None,None),initialize=-1.25004539694225)
m.x399 = Var(within=Reals,bounds=(None,None),initialize=-1.24966388906122)
m.x400 = Var(within=Reals,bounds=(None,None),initialize=-1.24927925158811)
m.x401 = Var(within=Reals,bounds=(None,None),initialize=-1.24889146777672)
m.x402 = Var(within=Reals,bounds=(None,None),initialize=-1.24850052090614)
m.x403 = Var(within=Reals,bounds=(None,None),initialize=-1.24810639428266)
m.x404 = Var(within=Reals,bounds=(None,None),initialize=-1.24770907124171)
m.x405 = Var(within=Reals,bounds=(None,None),initialize=-1.24730853514982)
m.x406 = Var(within=Reals,bounds=(None,None),initialize=-1.2469047694066)
m.x407 = Var(within=Reals,bounds=(None,None),initialize=-1.24649775744672)
m.x408 = Var(within=Reals,bounds=(None,None),initialize=-1.24608748274198)
m.x409 = Var(within=Reals,bounds=(None,None),initialize=-1.24567392880329)
m.x410 = Var(within=Reals,bounds=(0.01,None),initialize=13.2901172801406)
m.x411 = Var(within=Reals,bounds=(0.01,None),initialize=13.2900913844578)
m.x412 = Var(within=Reals,bounds=(0.01,None),initialize=13.2900652593087)
m.x413 = Var(within=Reals,bounds=(0.01,None),initialize=13.2900389032812)
m.x414 = Var(within=Reals,bounds=(0.01,None),initialize=13.2900123149624)
m.x415 = Var(within=Reals,bounds=(0.01,None),initialize=13.2899854929398)
m.x416 = Var(within=Reals,bounds=(0.01,None),initialize=13.2899584358005)
m.x417 = Var(within=Reals,bounds=(0.01,None),initialize=13.2899311421317)
m.x418 = Var(within=Reals,bounds=(0.01,None),initialize=13.2899036105212)
m.x419 = Var(within=Reals,bounds=(0.01,None),initialize=13.2898758395567)
m.x420 = Var(within=Reals,bounds=(0.01,None),initialize=13.2898478278268)
m.x421 = Var(within=Reals,bounds=(0.01,None),initialize=13.2898195739207)
m.x422 = Var(within=Reals,bounds=(0.01,None),initialize=13.2897910764284)
m.x423 = Var(within=Reals,bounds=(0.01,None),initialize=13.2897623339409)
m.x424 = Var(within=Reals,bounds=(0.01,None),initialize=13.2897333450505)
m.x425 = Var(within=Reals,bounds=(0.01,None),initialize=13.2897041083506)
m.x426 = Var(within=Reals,bounds=(0.01,None),initialize=13.2896746224361)
m.x427 = Var(within=Reals,bounds=(0.01,None),initialize=13.2896448859037)
m.x428 = Var(within=Reals,bounds=(0.01,None),initialize=13.2896148973518)
m.x429 = Var(within=Reals,bounds=(0.01,None),initialize=13.2895846553806)
m.x430 = Var(within=Reals,bounds=(0.01,None),initialize=13.2895541585928)
m.x431 = Var(within=Reals,bounds=(0.01,None),initialize=13.2895234055929)
m.x432 = Var(within=Reals,bounds=(0.01,None),initialize=13.2894923949883)
m.x433 = Var(within=Reals,bounds=(0.01,None),initialize=13.2894611253888)
m.x434 = Var(within=Reals,bounds=(0.01,None),initialize=13.2894295954072)
m.x435 = Var(within=Reals,bounds=(0.01,None),initialize=13.2893978036591)
m.x436 = Var(within=Reals,bounds=(0.01,None),initialize=13.2893657487633)
m.x437 = Var(within=Reals,bounds=(0.01,None),initialize=13.2893334293421)
m.x438 = Var(within=Reals,bounds=(0.01,None),initialize=13.2893008440212)
m.x439 = Var(within=Reals,bounds=(0.01,None),initialize=13.28926799143)
m.x440 = Var(within=Reals,bounds=(0.01,None),initialize=13.289234870202)
m.x441 = Var(within=Reals,bounds=(0.01,None),initialize=13.2892014789747)
m.x442 = Var(within=Reals,bounds=(0.01,None),initialize=13.2891678163897)
m.x443 = Var(within=Reals,bounds=(0.01,None),initialize=13.2891338810933)
m.x444 = Var(within=Reals,bounds=(0.01,None),initialize=13.2890996717364)
m.x445 = Var(within=Reals,bounds=(0.01,None),initialize=13.2890651869749)
m.x446 = Var(within=Reals,bounds=(0.01,None),initialize=13.2890304254696)
m.x447 = Var(within=Reals,bounds=(0.01,None),initialize=13.2889953858867)
m.x448 = Var(within=Reals,bounds=(0.01,None),initialize=13.2889600668977)
m.x449 = Var(within=Reals,bounds=(0.01,None),initialize=13.28892446718)
m.x450 = Var(within=Reals,bounds=(0.01,None),initialize=13.2888885854169)
m.x451 = Var(within=Reals,bounds=(0.01,None),initialize=13.2888524202976)
m.x452 = Var(within=Reals,bounds=(0.01,None),initialize=13.2888159705177)
m.x453 = Var(within=Reals,bounds=(0.01,None),initialize=13.2887792347794)
m.x454 = Var(within=Reals,bounds=(0.01,None),initialize=13.2887422117915)
m.x455 = Var(within=Reals,bounds=(0.01,None),initialize=13.28870490027)
m.x456 = Var(within=Reals,bounds=(0.01,None),initialize=13.2886672989378)
m.x457 = Var(within=Reals,bounds=(0.01,None),initialize=13.2886294065253)
m.x458 = Var(within=Reals,bounds=(0.01,None),initialize=13.2885912217706)
m.x459 = Var(within=Reals,bounds=(0.01,None),initialize=13.2885527434197)
m.x460 = Var(within=Reals,bounds=(0.01,None),initialize=13.2885139702263)
m.x461 = Var(within=Reals,bounds=(None,None),initialize=95.1919928108394)
m.x462 = Var(within=Reals,bounds=(None,None),initialize=95.1916218495908)
m.x463 = Var(within=Reals,bounds=(None,None),initialize=95.1912476019211)
m.x464 = Var(within=Reals,bounds=(None,None),initialize=95.1908700476184)
m.x465 = Var(within=Reals,bounds=(None,None),initialize=95.1904891664669)
m.x466 = Var(within=Reals,bounds=(None,None),initialize=95.1901049382485)
m.x467 = Var(within=Reals,bounds=(None,None),initialize=95.1897173427448)
m.x468 = Var(within=Reals,bounds=(None,None),initialize=95.1893263597397)
m.x469 = Var(within=Reals,bounds=(None,None),initialize=95.1889319690205)
m.x470 = Var(within=Reals,bounds=(None,None),initialize=95.188534150381)
m.x471 = Var(within=Reals,bounds=(None,None),initialize=95.1881328836229)
m.x472 = Var(within=Reals,bounds=(None,None),initialize=95.1877281485582)
m.x473 = Var(within=Reals,bounds=(None,None),initialize=95.1873199250115)
m.x474 = Var(within=Reals,bounds=(None,None),initialize=95.1869081928217)
m.x475 = Var(within=Reals,bounds=(None,None),initialize=95.1864929318451)
m.x476 = Var(within=Reals,bounds=(None,None),initialize=95.1860741219567)
m.x477 = Var(within=Reals,bounds=(None,None),initialize=95.1856517430531)
m.x478 = Var(within=Reals,bounds=(None,None),initialize=95.1852257750546)
m.x479 = Var(within=Reals,bounds=(None,None),initialize=95.1847961979077)
m.x480 = Var(within=Reals,bounds=(None,None),initialize=95.1843629915872)
m.x481 = Var(within=Reals,bounds=(None,None),initialize=95.1839261360988)
m.x482 = Var(within=Reals,bounds=(None,None),initialize=95.1834856114815)
m.x483 = Var(within=Reals,bounds=(None,None),initialize=95.18304139781)
m.x484 = Var(within=Reals,bounds=(None,None),initialize=95.1825934751972)
m.x485 = Var(within=Reals,bounds=(None,None),initialize=95.1821418237967)
m.x486 = Var(within=Reals,bounds=(None,None),initialize=95.1816864238056)
m.x487 = Var(within=Reals,bounds=(None,None),initialize=95.1812272554665)
m.x488 = Var(within=Reals,bounds=(None,None),initialize=95.1807642990707)
m.x489 = Var(within=Reals,bounds=(None,None),initialize=95.1802975349606)
m.x490 = Var(within=Reals,bounds=(None,None),initialize=95.179826943532)
m.x491 = Var(within=Reals,bounds=(None,None),initialize=95.1793525052376)
m.x492 = Var(within=Reals,bounds=(None,None),initialize=95.1788742005888)
m.x493 = Var(within=Reals,bounds=(None,None),initialize=95.178392010159)
m.x494 = Var(within=Reals,bounds=(None,None),initialize=95.1779059145866)
m.x495 = Var(within=Reals,bounds=(None,None),initialize=95.1774158945768)
m.x496 = Var(within=Reals,bounds=(None,None),initialize=95.1769219309057)
m.x497 = Var(within=Reals,bounds=(None,None),initialize=95.1764240044221)
m.x498 = Var(within=Reals,bounds=(None,None),initialize=95.1759220960511)
m.x499 = Var(within=Reals,bounds=(None,None),initialize=95.1754161867966)
m.x500 = Var(within=Reals,bounds=(None,None),initialize=95.1749062577445)
m.x501 = Var(within=Reals,bounds=(None,None),initialize=95.1743922900653)
m.x502 = Var(within=Reals,bounds=(None,None),initialize=95.1738742650177)
m.x503 = Var(within=Reals,bounds=(None,None),initialize=95.1733521639511)
m.x504 = Var(within=Reals,bounds=(None,None),initialize=95.1728259683089)
m.x505 = Var(within=Reals,bounds=(None,None),initialize=95.1722956596313)
m.x506 = Var(within=Reals,bounds=(None,None),initialize=95.171761219559)
m.x507 = Var(within=Reals,bounds=(None,None),initialize=95.1712226298357)
m.x508 = Var(within=Reals,bounds=(None,None),initialize=95.1706798723117)
m.x509 = Var(within=Reals,bounds=(None,None),initialize=95.1701329289469)
m.x510 = Var(within=Reals,bounds=(None,None),initialize=95.1695817818141)
m.x511 = Var(within=Reals,bounds=(None,None),initialize=95.1690264131021)
m.x512 = Var(within=Reals,bounds=(None,None),initialize=977.984902300242)
m.x513 = Var(within=Reals,bounds=(None,None),initialize=977.981091113085)
m.x514 = Var(within=Reals,bounds=(None,None),initialize=977.977246161846)
m.x515 = Var(within=Reals,bounds=(None,None),initialize=977.973367238873)
m.x516 = Var(within=Reals,bounds=(None,None),initialize=977.96945413647)
m.x517 = Var(within=Reals,bounds=(None,None),initialize=977.965506646923)
m.x518 = Var(within=Reals,bounds=(None,None),initialize=977.96152456251)
m.x519 = Var(within=Reals,bounds=(None,None),initialize=977.957507675534)
m.x520 = Var(within=Reals,bounds=(None,None),initialize=977.953455778336)
m.x521 = Var(within=Reals,bounds=(None,None),initialize=977.94936866332)
m.x522 = Var(within=Reals,bounds=(None,None),initialize=977.945246122971)
m.x523 = Var(within=Reals,bounds=(None,None),initialize=977.941087949883)
m.x524 = Var(within=Reals,bounds=(None,None),initialize=977.936893936777)
m.x525 = Var(within=Reals,bounds=(None,None),initialize=977.932663876522)
m.x526 = Var(within=Reals,bounds=(None,None),initialize=977.928397562164)
m.x527 = Var(within=Reals,bounds=(None,None),initialize=977.924094786944)
m.x528 = Var(within=Reals,bounds=(None,None),initialize=977.919755344323)
m.x529 = Var(within=Reals,bounds=(None,None),initialize=977.915379028007)
m.x530 = Var(within=Reals,bounds=(None,None),initialize=977.910965631968)
m.x531 = Var(within=Reals,bounds=(None,None),initialize=977.906514950471)
m.x532 = Var(within=Reals,bounds=(None,None),initialize=977.902026778099)
m.x533 = Var(within=Reals,bounds=(None,None),initialize=977.897500909777)
m.x534 = Var(within=Reals,bounds=(None,None),initialize=977.892937140794)
m.x535 = Var(within=Reals,bounds=(None,None),initialize=977.888335266836)
m.x536 = Var(within=Reals,bounds=(None,None),initialize=977.883695084005)
m.x537 = Var(within=Reals,bounds=(None,None),initialize=977.879016388847)
m.x538 = Var(within=Reals,bounds=(None,None),initialize=977.87429897838)
m.x539 = Var(within=Reals,bounds=(None,None),initialize=977.869542650121)
m.x540 = Var(within=Reals,bounds=(None,None),initialize=977.864747202109)
m.x541 = Var(within=Reals,bounds=(None,None),initialize=977.859912432937)
m.x542 = Var(within=Reals,bounds=(None,None),initialize=977.855038141777)
m.x543 = Var(within=Reals,bounds=(None,None),initialize=977.850124128408)
m.x544 = Var(within=Reals,bounds=(None,None),initialize=977.845170193247)
m.x545 = Var(within=Reals,bounds=(None,None),initialize=977.840176137371)
m.x546 = Var(within=Reals,bounds=(None,None),initialize=977.835141762555)
m.x547 = Var(within=Reals,bounds=(None,None),initialize=977.830066871291)
m.x548 = Var(within=Reals,bounds=(None,None),initialize=977.824951266827)
m.x549 = Var(within=Reals,bounds=(None,None),initialize=977.819794753189)
m.x550 = Var(within=Reals,bounds=(None,None),initialize=977.814597135215)
m.x551 = Var(within=Reals,bounds=(None,None),initialize=977.809358218584)
m.x552 = Var(within=Reals,bounds=(None,None),initialize=977.804077809848)
m.x553 = Var(within=Reals,bounds=(None,None),initialize=977.798755716459)
m.x554 = Var(within=Reals,bounds=(None,None),initialize=977.793391746807)
m.x555 = Var(within=Reals,bounds=(None,None),initialize=977.787985710242)
m.x556 = Var(within=Reals,bounds=(None,None),initialize=977.782537417114)
m.x557 = Var(within=Reals,bounds=(None,None),initialize=977.777046678803)
m.x558 = Var(within=Reals,bounds=(None,None),initialize=977.771513307745)
m.x559 = Var(within=Reals,bounds=(None,None),initialize=977.765937117476)
m.x560 = Var(within=Reals,bounds=(None,None),initialize=977.760317922653)
m.x561 = Var(within=Reals,bounds=(None,None),initialize=977.754655539096)
m.x562 = Var(within=Reals,bounds=(None,None),initialize=977.748949783816)
m.x563 = Var(within=Reals,bounds=(None,None),initialize=-0.0184535016360587)
m.x564 = Var(within=Reals,bounds=(None,None),initialize=-0.0186540595914072)
m.x565 = Var(within=Reals,bounds=(None,None),initialize=-0.018856437440154)
m.x566 = Var(within=Reals,bounds=(None,None),initialize=-0.0190606472851964)
m.x567 = Var(within=Reals,bounds=(None,None),initialize=-0.0192667012527758)
m.x568 = Var(within=Reals,bounds=(None,None),initialize=-0.019474611491673)
m.x569 = Var(within=Reals,bounds=(None,None),initialize=-0.0196843901723865)
m.x570 = Var(within=Reals,bounds=(None,None),initialize=-0.0198960494862983)
m.x571 = Var(within=Reals,bounds=(None,None),initialize=-0.020109601644825)
m.x572 = Var(within=Reals,bounds=(None,None),initialize=-0.0203250588785566)
m.x573 = Var(within=Reals,bounds=(None,None),initialize=-0.0205424334363785)
m.x574 = Var(within=Reals,bounds=(None,None),initialize=-0.0207617375845822)
m.x575 = Var(within=Reals,bounds=(None,None),initialize=-0.0209829836059582)
m.x576 = Var(within=Reals,bounds=(None,None),initialize=-0.0212061837988782)
m.x577 = Var(within=Reals,bounds=(None,None),initialize=-0.0214313504763599)
m.x578 = Var(within=Reals,bounds=(None,None),initialize=-0.021658495965119)
m.x579 = Var(within=Reals,bounds=(None,None),initialize=-0.0218876326046055)
m.x580 = Var(within=Reals,bounds=(None,None),initialize=-0.0221187727460244)
m.x581 = Var(within=Reals,bounds=(None,None),initialize=-0.0223519287513447)
m.x582 = Var(within=Reals,bounds=(None,None),initialize=-0.0225871129922899)
m.x583 = Var(within=Reals,bounds=(None,None),initialize=-0.0228243378493151)
m.x584 = Var(within=Reals,bounds=(None,None),initialize=-0.023063615710569)
m.x585 = Var(within=Reals,bounds=(None,None),initialize=-0.0233049589708403)
m.x586 = Var(within=Reals,bounds=(None,None),initialize=-0.023548380030489)
m.x587 = Var(within=Reals,bounds=(None,None),initialize=-0.0237938912943618)
m.x588 = Var(within=Reals,bounds=(None,None),initialize=-0.024041505170693)
m.x589 = Var(within=Reals,bounds=(None,None),initialize=-0.0242912340699887)
m.x590 = Var(within=Reals,bounds=(None,None),initialize=-0.0245430904038967)
m.x591 = Var(within=Reals,bounds=(None,None),initialize=-0.0247970865840587)
m.x592 = Var(within=Reals,bounds=(None,None),initialize=-0.0250532350209494)
m.x593 = Var(within=Reals,bounds=(None,None),initialize=-0.0253115481226966)
m.x594 = Var(within=Reals,bounds=(None,None),initialize=-0.0255720382938881)
m.x595 = Var(within=Reals,bounds=(None,None),initialize=-0.0258347179343605)
m.x596 = Var(within=Reals,bounds=(None,None),initialize=-0.0260995994379741)
m.x597 = Var(within=Reals,bounds=(None,None),initialize=-0.0263666951913686)
m.x598 = Var(within=Reals,bounds=(None,None),initialize=-0.0266360175727056)
m.x599 = Var(within=Reals,bounds=(None,None),initialize=-0.0269075789503924)
m.x600 = Var(within=Reals,bounds=(None,None),initialize=-0.0271813916817908)
m.x601 = Var(within=Reals,bounds=(None,None),initialize=-0.0274574681119094)
m.x602 = Var(within=Reals,bounds=(None,None),initialize=-0.0277358205720782)
m.x603 = Var(within=Reals,bounds=(None,None),initialize=-0.0280164613786074)
m.x604 = Var(within=Reals,bounds=(None,None),initialize=-0.0282994028314306)
m.x605 = Var(within=Reals,bounds=(None,None),initialize=-0.0285846572127275)
m.x606 = Var(within=Reals,bounds=(None,None),initialize=-0.0288722367855355)
m.x607 = Var(within=Reals,bounds=(None,None),initialize=-0.0291621537923393)
m.x608 = Var(within=Reals,bounds=(None,None),initialize=-0.029454420453646)
m.x609 = Var(within=Reals,bounds=(None,None),initialize=-0.0297490489665431)
m.x610 = Var(within=Reals,bounds=(None,None),initialize=-0.0300460515032385)
m.x611 = Var(within=Reals,bounds=(None,None),initialize=-0.0303454402095848)
m.x612 = Var(within=Reals,bounds=(None,None),initialize=-0.0306472272035846)
m.x613 = Var(within=Reals,bounds=(None,None),initialize=-0.0309514245738806)
m.x614 = Var(within=Reals,bounds=(None,None),initialize=0.0160499658066389)
m.x615 = Var(within=Reals,bounds=(None,None),initialize=0.0160112950561135)
m.x616 = Var(within=Reals,bounds=(None,None),initialize=0.015972277479662)
m.x617 = Var(within=Reals,bounds=(None,None),initialize=0.0159329108548878)
m.x618 = Var(within=Reals,bounds=(None,None),initialize=0.0158931929568897)
m.x619 = Var(within=Reals,bounds=(None,None),initialize=0.0158531215584485)
m.x620 = Var(within=Reals,bounds=(None,None),initialize=0.0158126944301937)
m.x621 = Var(within=Reals,bounds=(None,None),initialize=0.0157719093408222)
m.x622 = Var(within=Reals,bounds=(None,None),initialize=0.0157307640572473)
m.x623 = Var(within=Reals,bounds=(None,None),initialize=0.0156892563448157)
m.x624 = Var(within=Reals,bounds=(None,None),initialize=0.0156473839674973)
m.x625 = Var(within=Reals,bounds=(None,None),initialize=0.0156051446880845)
m.x626 = Var(within=Reals,bounds=(None,None),initialize=0.0155625362683782)
m.x627 = Var(within=Reals,bounds=(None,None),initialize=0.015519556469398)
m.x628 = Var(within=Reals,bounds=(None,None),initialize=0.0154762030516036)
m.x629 = Var(within=Reals,bounds=(None,None),initialize=0.0154324737750873)
m.x630 = Var(within=Reals,bounds=(None,None),initialize=0.015388366399776)
m.x631 = Var(within=Reals,bounds=(None,None),initialize=0.0153438786856714)
m.x632 = Var(within=Reals,bounds=(None,None),initialize=0.0152990083930558)
m.x633 = Var(within=Reals,bounds=(None,None),initialize=0.0152537532826926)
m.x634 = Var(within=Reals,bounds=(None,None),initialize=0.0152081111160882)
m.x635 = Var(within=Reals,bounds=(None,None),initialize=0.0151620796556884)
m.x636 = Var(within=Reals,bounds=(None,None),initialize=0.0151156566651167)
m.x637 = Var(within=Reals,bounds=(None,None),initialize=0.015068839909409)
m.x638 = Var(within=Reals,bounds=(None,None),initialize=0.0150216271552424)
m.x639 = Var(within=Reals,bounds=(None,None),initialize=0.0149740161711822)
m.x640 = Var(within=Reals,bounds=(None,None),initialize=0.0149260047279167)
m.x641 = Var(within=Reals,bounds=(None,None),initialize=0.0148775905985001)
m.x642 = Var(within=Reals,bounds=(None,None),initialize=0.0148287715586033)
m.x643 = Var(within=Reals,bounds=(None,None),initialize=0.0147795453867641)
m.x644 = Var(within=Reals,bounds=(None,None),initialize=0.0147299098646378)
m.x645 = Var(within=Reals,bounds=(None,None),initialize=0.0146798627772604)
m.x646 = Var(within=Reals,bounds=(None,None),initialize=0.0146294019132931)
m.x647 = Var(within=Reals,bounds=(None,None),initialize=0.0145785250653017)
m.x648 = Var(within=Reals,bounds=(None,None),initialize=0.0145272300300121)
m.x649 = Var(within=Reals,bounds=(None,None),initialize=0.0144755146085771)
m.x650 = Var(within=Reals,bounds=(None,None),initialize=0.0144233766068567)
m.x651 = Var(within=Reals,bounds=(None,None),initialize=0.0143708138356846)
m.x652 = Var(within=Reals,bounds=(None,None),initialize=0.0143178241111563)
m.x653 = Var(within=Reals,bounds=(None,None),initialize=0.0142644052548881)
m.x654 = Var(within=Reals,bounds=(None,None),initialize=0.0142105550943281)
m.x655 = Var(within=Reals,bounds=(None,None),initialize=0.0141562714630279)
m.x656 = Var(within=Reals,bounds=(None,None),initialize=0.0141015522009322)
m.x657 = Var(within=Reals,bounds=(None,None),initialize=0.0140463951546774)
m.x658 = Var(within=Reals,bounds=(None,None),initialize=0.0139907981778808)
m.x659 = Var(within=Reals,bounds=(None,None),initialize=0.0139347591314518)
m.x660 = Var(within=Reals,bounds=(None,None),initialize=0.0138782758838776)
m.x661 = Var(within=Reals,bounds=(None,None),initialize=0.0138213463115484)
m.x662 = Var(within=Reals,bounds=(None,None),initialize=0.0137639682990418)
m.x663 = Var(within=Reals,bounds=(None,None),initialize=0.0137061397394671)
m.x664 = Var(within=Reals,bounds=(None,None),initialize=0.0136478585347426)
m.x666 = Var(within=Reals,bounds=(0,None),initialize=0.02)

m.obj = Objective(expr=   m.x52, sense=maximize)
