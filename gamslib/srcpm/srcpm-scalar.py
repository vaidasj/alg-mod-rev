...
m.x17 = Var(within=Reals,bounds=(0,None),initialize=5.56103683518172)
m.x18 = Var(within=Reals,bounds=(0,None),initialize=0.312071787775984)
...
m.x30 = Var(within=Reals,bounds=(0,1.7),initialize=0.928008053710257)
m.x31 = Var(within=Reals,bounds=(0,1.9),initialize=0.268195340806018)
...
m.obj = Objective(expr=(-3865470.5664*m.x34**(-4)) - 5130022.82472*m.x35**(-4) - 423446.869122501*m.x36**(-4) - 
                       1808.40439881057*m.x37**(-2.33333333333333) - 17313.2956782741*m.x38**(-2.33333333333333) - m.x39
                       , sense=maximize)
