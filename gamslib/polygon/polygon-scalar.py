...
m.x27 = Var(within=Reals,bounds=(0,3.14159265358979),initialize=0.251327412287184)
...
m.x31 = Var(within=Reals,bounds=(0,3.14159265358979),initialize=0.753982236861551)
...
m.obj = Objective(expr=0.5*(m.x2*m.x1*sin(m.x27 - m.x26) + m.x3*m.x2*sin(m.x28 - m.x27) + m.x4*m.x3*sin(m.x29 - m.x28)
                       ...
                       sin(m.x50 - m.x49)), sense=maximize)
