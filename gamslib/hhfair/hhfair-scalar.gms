...
*         81       60       21        0
*
*  Solve m using NLP maximizing x18;
...
e1.. -x25**1*x26**0.944*x27**0.891136 + x18 =E= 0;

e2.. -0.01*(0.5*x5**0.5 + 0.5*(1004.72366 - x8 - x15)**0.5)**2 + x25 =E= 0;

e3.. -0.01*(0.5*x6**0.5 + 0.5*(1004.72366 - x9 - x16)**0.5)**2 + x26 =E= 0;

e4.. -0.01*(0.5*x7**0.5 + 0.5*(1004.72366 - x10 - x17)**0.5)**2 + x27 =E= 0;
