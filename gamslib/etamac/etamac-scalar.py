...
m.c9 = Constraint(expr=-(0.820744282617517*m.x10**(-0.342222222222222) + 0.306708090151269*m.x45**(-0.427777777777778)*
                       m.x63**(-0.794444444444445))**(-0.818181818181818) + m.x27 == 0)

m.c10 = Constraint(expr=-(0.720649479632698*m.x11**(-0.342222222222222) + 0.306708090151269*m.x46**(-0.427777777777778)*
                        m.x64**(-0.794444444444445))**(-0.818181818181818) + m.x28 == 0)

m.c11 = Constraint(expr=-(0.632761852252706*m.x12**(-0.342222222222222) + 0.306708090151269*m.x47**(-0.427777777777778)*
                        m.x65**(-0.794444444444445))**(-0.818181818181818) + m.x29 == 0)

m.c12 = Constraint(expr=-(0.555592660485019*m.x13**(-0.342222222222222) + 0.306708090151269*m.x48**(-0.427777777777778)*
                        m.x66**(-0.794444444444445))**(-0.818181818181818) + m.x30 == 0)

m.c13 = Constraint(expr=-(0.487834725317074*m.x14**(-0.342222222222222) + 0.306708090151269*m.x49**(-0.427777777777778)*
                        m.x67**(-0.794444444444445))**(-0.818181818181818) + m.x31 == 0)

m.c14 = Constraint(expr=-(0.428340286240339*m.x15**(-0.342222222222222) + 0.306708090151269*m.x50**(-0.427777777777778)*
                        m.x68**(-0.794444444444445))**(-0.818181818181818) + m.x32 == 0)

m.c15 = Constraint(expr=-(0.376101559185242*m.x16**(-0.342222222222222) + 0.306708090151269*m.x51**(-0.427777777777778)*
                        m.x69**(-0.794444444444445))**(-0.818181818181818) + m.x33 == 0)

m.c16 = Constraint(expr=-(0.330233665535262*m.x17**(-0.342222222222222) + 0.306708090151269*m.x52**(-0.427777777777778)*
...
m.c43 = Constraint(expr=-(0.612508399277048 + 0.306708090151269*m.x44**(-0.427777777777778)*m.x62**(-0.794444444444445))
