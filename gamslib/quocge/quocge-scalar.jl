#  NLP written by GAMS Convert at 10/11/20 12:52:27
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#         55       53        2        0        0        0        0        0
...
@constraint(m,  - 12.7777777777778*x27 - 10.2222222222222*x28 + x44 - 0.255555555555556*x49 - 0.255555555555556*x50
     == 0)
...
JuMP.add_NL_constraint(m, :(-0.0769230769230769*$(x37)*$(x21) + $(x47) == 0))

JuMP.add_NL_constraint(m, :(-0.181818181818182*$(x38)*$(x22) + $(x48) == 0))
...
@constraint(m,  - 9.44444444444444*x27 - 7.55555555555556*x28 + x42 - 0.188888888888889*x49 - 0.188888888888889*x50
     == 0)
...
JuMP.add_NL_constraint(m, :(-(20*$(x27) + 16*$(x28) - 0.4*$(x42) - 0.4*$(x44) + 0.4*$(x49) + 0.4*$(x50))/$(x33) + $(x13)
     == 0))

JuMP.add_NL_constraint(m, :(-(30*$(x27) + 24*$(x28) - 0.6*$(x42) - 0.6*$(x44) + 0.6*$(x49) + 0.6*$(x50))/$(x34) + $(x14)
     == 0))

JuMP.add_NL_constraint(m, :(-$(x52)*$(x37)*$(x21) + $(x49) == 0))

JuMP.add_NL_constraint(m, :(-$(x53)*$(x38)*$(x22) + $(x50) == 0))
...
JuMP.add_NL_constraint(m, :(-(0.423659272868161*$(x33)/((1.07692307692308 + $(x52))*$(x37)))^2*$(x23) + $(x21) == 0))

JuMP.add_NL_constraint(m, :(-(0.425145461109024*$(x34)/((1.18181818181818 + $(x53))*$(x38)))^2*$(x24) + $(x22) == 0))
...
JuMP.add_NL_constraint(m, :($(x52)*(11.7 - $(x21)) == 0))

JuMP.add_NL_constraint(m, :($(x53)*(1100 - $(x22)) == 0))

@constraint(m,  - x21 >= -11.7)

@constraint(m,  - x22 >= -1100)
