...
e18: -0.0769230769230769*x37*x21 + x47 = 0;

e19: -0.181818181818182*x38*x22 + x48 = 0;
...
e26: -(20*x27 + 16*x28 - 0.4*x42 - 0.4*x44 + 0.4*x49 + 0.4*x50)/x33 + x13 = 0;

e27: -(30*x27 + 24*x28 - 0.6*x42 - 0.6*x44 + 0.6*x49 + 0.6*x50)/x34 + x14 = 0;

e28: -x52*x37*x21 + x49 = 0;

e29: -x53*x38*x22 + x50 = 0;
...
e35: -1.78631298097427*(0.316984436431308*x21**0.5 + 0.683015563568692*x25**0.5
     )**2 + x23 = 0;

e36: -1.8103795278422*(0.315975006847877*x22**0.5 + 0.684024993152123*x26**0.5)
     **2 + x24 = 0;

e37: -(0.423659272868161*x33/((1.07692307692308 + x52)*x37))**2*x23 + x21 = 0;

e38: -(0.425145461109024*x34/((1.18181818181818 + x53)*x38))**2*x24 + x22 = 0;

e39: -(0.912870929175277*x33/x39)**2*x23 + x25 = 0;

e40: -(0.920357986616844*x34/x40)**2*x24 + x26 = 0;
...
e45: -2.42780549270868*(0.747349691412928*x19**1.5 + 0.252650308587072*x25**1.5
     )**0.666666666666667 + x11 = 0;

e46: -2.91102542459458*(0.809256430169454*x20**1.5 + 0.190743569830546*x26**1.5
     )**0.666666666666667 + x12 = 0;

e47: -(1.02120377146637*x31/x39)**(-2)*x11 + x25 = 0;

e48: -(1*x32/x40)**(-2)*x12 + x26 = 0;

e49: -(3.02076149339864*x31/x35)**(-2)*x11 + x19 = 0;

e50: -(4.24264068711929*x32/x36)**(-2)*x12 + x20 = 0;

e51:  - x7 - x8 - x13 - x15 - x17 + x23 = 0;

e52:  - x9 - x10 - x14 - x16 - x18 + x24 = 0;
