...
m.x1 = Var(within=Reals,bounds=(1,None),initialize=2.65787165646339)
m.x2 = Var(within=Reals,bounds=(1,None),initialize=2.82088780167557)
...
m.x5 = Var(within=Reals,bounds=(1,None),initialize=3.37233255315756)
m.x6 = Var(within=Reals,bounds=(1,None),initialize=3.57910964624528)
m.x7 = Var(within=Reals,bounds=(1,None),initialize=3.7985498695696)
m.x8 = Var(within=Reals,bounds=(1,None),initialize=4.03142783910829)
m.x9 = Var(within=Reals,bounds=(1,None),initialize=4.27856550499248)
m.x10 = Var(within=Reals,bounds=(1,None),initialize=4.54083504110912)
m.x11 = Var(within=Reals,bounds=(1,None),initialize=4.81916191094404)
m.x12 = Var(within=Reals,bounds=(1,None),initialize=5.11452812040596)
m.x13 = Var(within=Reals,bounds=(1,None),initialize=5.42797566902517)
m.x14 = Var(within=Reals,bounds=(1,None),initialize=5.76061021161472)
m.x15 = Var(within=Reals,bounds=(1,None),initialize=6.11360494321832)
...
m.x18 = Var(within=Reals,bounds=(1,None),initialize=7.30758365919499)
m.x19 = Var(within=Reals,bounds=(1,None),initialize=7.75525155216024)
m.x20 = Var(within=Reals,bounds=(1,None),initialize=8.23031210161429)
...
m.x59 = Var(within=Reals,bounds=(1,None),initialize=38.9952351348076)
...
m.obj = Objective(expr=10*m.x1**0.1 + 9.70873786407767*m.x2**0.1 + 9.42595909133755*m.x3**0.1 + 9.1514165935316*m.x4**
                       ...
                       6.80951339993178*m.x14**0.1 + 6.61117805818619*m.x15**0.1 + 6.41861947396718*m.x16**0.1 + 
                       6.23166939220114*m.x17**0.1 + 6.05016445844771*m.x18**0.1 + 5.87394607616282*m.x19**0.1 + 
                       5.70286026811925*m.x20**0.1, sense=maximize)
