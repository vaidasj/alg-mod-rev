...
m.obj = Objective(expr=m.x61**0.47*m.x62**0.31999*m.x63**0.21001, sense=maximize)
...
m.c36 = Constraint(expr=m.x36/m.x33 - (0.213062254354894*m.x10/m.x4)**2 == 0)
...
m.c46 = Constraint(expr=m.x17*m.x61 - (0.9109*(0.47 - 0.47*m.x84)*m.x93 + 0.9109*(0.47 - 0.47*m.x85)*m.x94) == 0)

m.c47 = Constraint(expr=m.x18*m.x62 - (0.9109*(0.31999 - 0.31999*m.x84)*m.x93 + 0.9109*(0.31999 - 0.31999*m.x85)*m.x94)
                         == 0)

m.c48 = Constraint(expr=m.x19*m.x63 - (0.9109*(0.21001 - 0.21001*m.x84)*m.x93 + 0.9109*(0.21001 - 0.21001*m.x85)*m.x94)
                         == 0)
