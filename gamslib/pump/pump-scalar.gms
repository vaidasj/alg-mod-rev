...
e1.. -((6329.03 + 1800*x1)*i16*i19*b22 + (2489.31 + 1800*x2)*i17*i20*b23 + (
     3270.27 + 1800*x3)*i18*i21*b24) + x25 =E= 0;
...
e5.. -(0.000235932203389831*x4*x10 + 629*sqr(0.000338983050847458*x4) - 0.0116*
     sqr(x10)) + x7 =E= 0;

e6.. -(0.001*x5*x11 + 215*sqr(0.000338983050847458*x5) - 0.115*sqr(x11)) + x8
      =E= 0;

e7.. -(0.000179661016949153*x6*x12 + 361*sqr(0.000338983050847458*x6) - 0.00946
     *sqr(x12)) + x9 =E= 0;
