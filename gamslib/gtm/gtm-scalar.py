#  NLP written by GAMS Convert at 12/13/18 10:24:39
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#         25        1       14       10        0        0        0        0
...
m.obj = Objective(expr=(-4.84*m.x50**(-1)) - 0.14*m.x51**(-1) - 6.4827*m.x52**(-1) - 6.6654*m.x53**(-1) - 
                       8.89583741831423*m.x54**(-0.666666666666667) - 20.7788808225955*m.x55**(-0.515151515151515) - 
                       12.8222379289592*m.x56**(-0.538461538461538) - 112.274462577384*m.x57**(-0.123595505617978) - 
                       78.984522912416*m.x58**(-0.538461538461538) - 325.606233858943*m.x59**(-0.19047619047619) - 
                       19.9925533406708*m.x60**(-0.492537313432836) - 20.2959676146409*m.x61**(-0.851851851851852) - 
                       34.6492709112034*m.x62**(-1.32558139534884) - 2.07326743881507*m.x63**(-0.754385964912281) - (
                       0.0372*m.x44 - 6.47537234042553*log(1 - 0.102564102564103*m.x44) - 0.489999999999999*log(1 - 
                       1.38888888888889*m.x43) - 1.68*log(1 - 0.392156862745098*m.x45) + (-1.2271875*log(1 - 
                       0.581395348837209*m.x46)) - 0.2187*m.x46 - 0.979999999999999*log(1 - 0.694444444444444*m.x47) - 
                       0.35*log(1 - 1.92307692307692*m.x48)) - 0.25*m.x1 - 2.29*m.x2 - 2.22*m.x3 - 2.03*m.x4 - 1.96*m.x5
                        - 2.13*m.x6 - 0.4*m.x7 - 0.9*m.x8 - 1.15*m.x9 - 1.1*m.x10 - 1.1*m.x11 - 0.8*m.x12 - 0.8*m.x13
                        - 0.65*m.x14 - 0.7*m.x15 - 0.65*m.x16 - 1.5*m.x18 - 0.72*m.x19 - 0.46*m.x20 - 2.12*m.x21
                        - 1.08*m.x22 - 1.01*m.x23 - 0.82*m.x24 - 0.75*m.x25 - 0.04*m.x26 - 0.86*m.x27 - 0.14*m.x28
                        - 0.64*m.x29 - 0.77*m.x30 - 0.05*m.x31 - 0.94*m.x32 - 0.53*m.x33 - 0.31*m.x34 - 0.58*m.x35
                        - 0.7*m.x36 - 1.91*m.x37 - 0.43*m.x38 - 6*m.x39 - 2*m.x49, sense=maximize)
